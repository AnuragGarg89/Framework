 ...
 * @date March 20, 2018
 * @description: Verify 'Unlock Later' lock test for all students
 *
 */
public class GLP_316551_VerifyUnlockLaterLockTestForAllStudents
        extends BaseClass {
    public GLP_316551_VerifyUnlockLaterLockTestForAllStudents() {
    }

    @Test(groups = { Groups.INSTRUCTOR, Groups.REGRESSION,
            Groups.NEWCOURSEREQUIRED }, enabled = true,
            description = "Verify 'Unlock Later' lock test for all students")
    public void verifyUnlockLaterLockTestForAllStudents()
            throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify 'Unlock Later' lock test for all students");
        ...
        try {
            ...
            objGLPInstructorDashboardPage.verifyElementAttributeValue(
                    ...
                    "Verify 'Lock button' is disbale for student.");
