 ...
 * @date Feb 18, 2018
 * @description :To verify that student able to view TOC after click on drawer
 *              icon on Core Instruction page
 * 
 */

public class GLP_310978_VerifyTOCCoreInstructionPage extends BaseClass {
	public GLP_310978_VerifyTOCCoreInstructionPage() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT, Groups.LEARNER,
			Groups.TOC }, enabled = true, description = "To verify that student able to view TOC after click on drawer icon on Core Instruction page")
	public void verifyTOCCoreInstructionPage() {
		startReport(
				getTestCaseId(),
				"To verify that student able to view TOC after click on drawer icon on Core Instruction page");
		...
		try {
			...
			objGLPLearnerCourseMaterialPage.verifyTOC();
