 ...
 * @author rashmi.z
 * @date Jan 05, 2018
 * @description: Verify MCQ-SA rendering solution part on card two
 * 
 */
public class GLP_287319_VerifyMCQSARenderingOnCardTwo extends BaseClass {
    public GLP_287319_VerifyMCQSARenderingOnCardTwo() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT, Groups.MCQSA,
            Groups.LEARNER }, enabled = true,
            description = "Verify MCQ-SA rendering solution part on card two")
    public void verifyMCQSARenderingOnCardTwo() {
        startReport(getTestCaseId(),
                "Verify MCQ-SA rendering solution part on card two");
        ...
        try {
            ...
            // Navigate to MCQSA type Question
            ...
            objProductApplication_DiagnosticTestPage
                    .verifyQuestionAnswerInCardView(1);
