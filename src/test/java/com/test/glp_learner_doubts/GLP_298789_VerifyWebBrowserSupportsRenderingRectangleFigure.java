 ...
 * @author rashmi.z
 * @date Jan 25, 2018
 * @description: To verify web browser supports rendering Rectangle figure
 * 
 */
public class GLP_298789_VerifyWebBrowserSupportsRenderingRectangleFigure
        extends BaseClass {
    public GLP_298789_VerifyWebBrowserSupportsRenderingRectangleFigure() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.FIGURE,
            Groups.LEARNER }, enabled = false,
            description = "Verify Web support for rendering rectangle figure.")
    public void VerifyWebBrowserSupportsRenderingRectangleFigure() {
        ...
        try {
            ...
            objProductApplication_DiagnosticTestPage.verifyElementPresent(
                    "DiagnosticfigureTypeRectangleWithoutDistortion",
                    "Figure should be rendered on the GLP UI without distortion.");
