 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 12.5
 *
 */
public class GLP_350891_VerifyCoreInstructionLo12_5 extends BaseClass {
	public GLP_350891_VerifyCoreInstructionLo12_5() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR, Groups.HEARTBEAT }, enabled = true, description = "Verify that Instructor is able to verify core instruction for LO 12.5")
	public void verifyCoreInstructionLo12_5() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 12.5");
		...
		try {
			...
			// Navigate to the EO's of LO 12.5
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("12.5");
