 ...
 *              Questions for LO 13.6
 */
public class GLP_346320_VerifyPreviewQuestionsLo13_6 extends BaseClass {
    public GLP_346320_VerifyPreviewQuestionsLo13_6() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR, Groups.HEARTBEAT },
            enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 13.6")
    public void verifyPreviewQuestionsLO_13_6() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 13.6");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 13.6
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("13.6");
