 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 13.3
 *
 */
public class GLP_350895_VerifyCoreInstructionLo13_3 extends BaseClass {
	public GLP_350895_VerifyCoreInstructionLo13_3() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR, Groups.HEARTBEAT, Groups.TEST }, enabled = false, description = "Verify that Instructor is able to verify core instruction for LO 13.3")
	public void verifyCoreInstructionLo13_3() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 13.3");
		...
		try {
			...
			// Navigate to the EO's of LO 13.3
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("13.3");
