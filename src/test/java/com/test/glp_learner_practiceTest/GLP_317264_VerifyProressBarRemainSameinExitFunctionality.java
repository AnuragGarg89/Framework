 ...
 * 
 */
public class GLP_317264_VerifyProressBarRemainSameinExitFunctionality
        extends BaseClass {
    public GLP_317264_VerifyProressBarRemainSameinExitFunctionality() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER }, enabled = true,
            description = "Validate that progress bar should ramin same if leraner again go to same question after exiting the practice test")
    public void VerifyProgressBarNoChangePracticeTest() {
        startReport(getTestCaseId(),
                "Validate that progress bar should ramin same if leraner again go to same question after exiting the practice test");
        ...
        try {
            ...
            String progressBarWidthValueBeforeExit = objGLPLearnerPracticeTestPage
            ...
            objGLPLearnerPracticeTestPage.clickOnElement(
                    ...
                    "Click on practice test continus button");

            String progressBarWidthValueAfterExit = objGLPLearnerPracticeTestPage
                    .getCurrentWidthOfProgressBar();
            objGLPLearnerPracticeTestPage.verifyProgressBarNoIncrease(
