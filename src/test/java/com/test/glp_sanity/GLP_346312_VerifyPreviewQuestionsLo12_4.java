 ...
 *              Questions for LO 12.4
 */
public class GLP_346312_VerifyPreviewQuestionsLo12_4 extends BaseClass {
    public GLP_346312_VerifyPreviewQuestionsLo12_4() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR, Groups.HEARTBEAT },
            enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 12.4")
    public void verifyPreviewQuestionsLO_12_4() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 12.4");
        ...
        try {
            ...
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("12.4");
