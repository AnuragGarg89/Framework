 ...
 *               standards for the Multipart question on dignosist -Multipart
 *               question
 */
public class GLP_283575_VerifyAccessibilityLearnerDiagnosticMultiPartPage
        extends BaseClass {
    public GLP_283575_VerifyAccessibilityLearnerDiagnosticMultiPartPage() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.ACCESSIBILITY, Groups.LEARNER },
            enabled = true,
            description = "Verify Web Content Accessibility Guidelines (WCAG) 2.0 with AA standards for the Multipart question on dignosist -Multipart question")
    public void verifyAccessibilityLearnerDiagnosticMultiPartPage() {
        startReport(getTestCaseId(),
                "Verify Web Content Accessibility Guidelines (WCAG) 2.0 with AA standards for the Multipart question on dignosist -Multipart question");
