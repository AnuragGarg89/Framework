 ...
 * @date Dec 18, 2017
 * @description: To verify "Read" verb will be available and used for narrative
 *               text sub-heading, at arrow label at footer navigation based on
 *               target content type to be rendered
 * 
 */
public class GLP_317208_VerifyReadVerbOnFooterNavigationTOC extends BaseClass {
	public GLP_317208_VerifyReadVerbOnFooterNavigationTOC() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT, Groups.LEARNER,
			Groups.TOC }, enabled = true, description = "To verify 'Read' verb will be available and used for narrative text sub-heading, at arrow label at footer navigation based on target content type to be rendered ")
	public void verifyeadVerbOnFooterNavigationTOC() {
		startReport(
				getTestCaseId(),
				"To verify Read verb will be available and used for narrative text sub-heading, at arrow label at footer navigation based on target content type to be rendered ");
		...
		try {
			...
			objGLPLearnerCourseMaterialPage
					.VerifyFooterVerbs("content", "Read");
