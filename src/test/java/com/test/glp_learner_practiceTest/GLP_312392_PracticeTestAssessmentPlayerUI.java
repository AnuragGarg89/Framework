/*
 * PEv ARSON PROPRIETARY AND CONFIDENTIAL INFORMATION SUBJECT TO NDA 
...
public class GLP_312392_PracticeTestAssessmentPlayerUI extends BaseClass {

    public GLP_312392_PracticeTestAssessmentPlayerUI() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER }, enabled = true,
            description = "Verify the UI of the Practice Test Assessment player")
    public void verifyPracticeTestUI() {
