 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 11.4
 *
 */
public class GLP_350886_VerifyCoreInstructionLo11_4 extends BaseClass {
	public GLP_350886_VerifyCoreInstructionLo11_4() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR, Groups.HEARTBEAT }, enabled = true, description = "Verify that Instructor is able to verify core instruction for LO 11.4")
	public void verifyCoreInstructionLo11_4() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 11.4");
		...
		try {
			...
			// Navigate to the Eo's of LO 11.4
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("11.4");
