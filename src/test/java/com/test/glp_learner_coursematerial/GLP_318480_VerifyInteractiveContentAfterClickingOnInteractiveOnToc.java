 ...
 * @date Dec 18, 2017
 * @description: Verify that on On clicking Interactive (write) content in TOC ,
 *               respective Interactive content should be displayed on right
 *               side of page
 */
public class GLP_318480_VerifyInteractiveContentAfterClickingOnInteractiveOnToc
        extends BaseClass {
    public GLP_318480_VerifyInteractiveContentAfterClickingOnInteractiveOnToc() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT, Groups.LEARNER,
            Groups.TOC }, enabled = true,
            description = "Verify that on On clicking Interactive (write) content in TOC , respective Interactive content should be displayed on right side of page")
    public void verifyInteractiveContentAfterClickingOnInteractiveOnToc() {
        startReport(getTestCaseId(),
                "Verify that on On clicking Interactive (write) content in TOC , respective Interactive content should be displayed on right side of page");
        ...
        try {
            ...
            // Navigate and Attempt Diagnostic test
            ...
            objGLPLearnerCourseMaterialPage
                    .navigateToCoreInstructionsInLo("12.2");
            ...
            // Select Edit Content
            objGLPLearnerCourseMaterialPage.clickOnElement("SubheadingEdit",
                    "Click on Edit Content");

            // Verify Edit content is available and opened
            objGLPLearnerCourseMaterialPage.verifyElementPresent("EditContent",
                    "Verify Edit content is available.");
