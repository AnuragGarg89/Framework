 ...
 * @date Dec 18, 2017
 * @description: To verify "Interact" verb will be available and used for
 *               practice test and interaction sub-heading, at arrow label at
 *               footer navigation based on target content type to be rendered
 * 
 */
public class GLP_317210_VerifyInteractVerbOnFooterNavigationTOC extends
		BaseClass {
	public GLP_317210_VerifyInteractVerbOnFooterNavigationTOC() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT, Groups.LEARNER,
			Groups.TOC }, enabled = true, description = "To verify Interact verb will be available and used for practice test and interaction sub-heading, at arrow label at footer navigation based on target content type to be rendered ")
	public void verifyCardViewMultiSelectQuestion() {
		startReport(
				getTestCaseId(),
				"To verify Interact verb will be available and used for practice test and interaction sub-heading, at arrow label at footer navigation based on target content type to be rendered ");
		...
		try {
			...
			objGLPLearnerCourseMaterialPage.VerifyFooterVerbs("quizz",
					"Interact");
