 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 12.3
 *
 */
public class GLP_350889_VerifyCoreInstructionLo12_3 extends BaseClass {
	public GLP_350889_VerifyCoreInstructionLo12_3() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR, Groups.HEARTBEAT }, enabled = true, description = "Verify that Instructor is able to verify core instruction for LO 12.3")
	public void verifyCoreInstructionLo12_3() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 12.3");
		...
		try {
			...
			// Navigate to the EO's of LO 12.3
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("12.3");
