 ...
 * 
 */
public class GLP_327917_VerifySaveProgessForStudyGuideOnTOCAfterLogout extends
		BaseClass {
	public GLP_327917_VerifySaveProgessForStudyGuideOnTOCAfterLogout() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT, Groups.LEARNER,
			Groups.TOC }, enabled = true, description = "To verify when user exit the study guide by logging out out the application then user should be displayed the same page in study guide on returning.")
	public void verifyCardViewMultiSelectQuestion() {
		...
		try {
			...
			objGLPLearnerCourseMaterialPage.clickOnElement("StudyGuide",
					"Click on SubHeading List Two");
			...
			objGLPLearnerCourseMaterialPage.clickOnElement(
					"CourseMaterialLOStartButton",
					"Click Start button on Core Instruction page");
