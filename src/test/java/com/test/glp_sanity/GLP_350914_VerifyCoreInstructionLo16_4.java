 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 16.4
 *
 */
public class GLP_350914_VerifyCoreInstructionLo16_4 extends BaseClass {
	public GLP_350914_VerifyCoreInstructionLo16_4() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR }, enabled = true, description = "Verify that Instructor is able to verify core instruction for LO 16.4")
	public void verifyCoreInstructionLo16_4() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 16.4");
		...
		try {
			...
			// Navigate to the EO's of LO 16.4
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("16.4");
