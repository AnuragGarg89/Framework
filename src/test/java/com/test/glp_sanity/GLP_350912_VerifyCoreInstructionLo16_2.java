 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 16.2
 *
 */
public class GLP_350912_VerifyCoreInstructionLo16_2 extends BaseClass {
	public GLP_350912_VerifyCoreInstructionLo16_2() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR }, enabled = true, description = "Verify that Instructor is able to verify core instruction for LO 16.2")
	public void verifyCoreInstructionLo16_2() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 16.2");
		...
		try {
			...
			// Navigate to the EO's of LO 16.2
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("16.2");
