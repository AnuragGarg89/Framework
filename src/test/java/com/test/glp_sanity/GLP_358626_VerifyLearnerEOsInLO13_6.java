 ...
 * 
 */
public class GLP_358626_VerifyLearnerEOsInLO13_6 extends BaseClass {
    public GLP_358626_VerifyLearnerEOsInLO13_6() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT, Groups.LEARNER,
            Groups.SANITY,Groups.DEV }, enabled = true,
            description = "LO-13.6 : To verify that all EOs and its contents are available to the learner and learner can complete the practice test available in each EO")
    public void verifyLearnerEOsInL013_6() {
        startReport(getTestCaseId(),
                "LO-13.6 : To verify that all EOs and its contents are available to the learner and learner can complete the practice test available in each EO");
        ...
        try {
            ...
            // Navigate to the Learning objectives page for LO 13.6
            GLPLearner_LearningObjectivePage objLO = objGLPLearnerCourseMaterialPage
                    .navigateToCoreInstructionsInLo("13.6");
