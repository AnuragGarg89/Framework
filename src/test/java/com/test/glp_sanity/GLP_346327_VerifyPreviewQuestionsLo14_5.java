 ...
 *              Questions for LO 14.5
 */
public class GLP_346327_VerifyPreviewQuestionsLo14_5 extends BaseClass {
    public GLP_346327_VerifyPreviewQuestionsLo14_5() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR, Groups.HEARTBEAT},
            enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 14.5")
    public void verifyPreviewQuestionsLO_14_5() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 14.5");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 14.5
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("14.5");
