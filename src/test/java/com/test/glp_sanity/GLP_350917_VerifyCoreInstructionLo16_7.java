 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 16.7
 *
 */
public class GLP_350917_VerifyCoreInstructionLo16_7 extends BaseClass {
	public GLP_350917_VerifyCoreInstructionLo16_7() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR }, enabled = true, description = "Verify that Instructor is able to verify core instruction for LO 16.7")
	public void verifyCoreInstructionLo16_7() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 16.7");
		...
		try {
			...
			// Navigate to the EO's of LO 16.7
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("16.7");
