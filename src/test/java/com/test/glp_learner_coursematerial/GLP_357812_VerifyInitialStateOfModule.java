 ...
 *              should be one module with a Start button at a time. Verify that
 *              'Continue' button in collapsed state would be displayed when any
 *              module LO has been started and after login and logout
 * 
 */
public class GLP_357812_VerifyInitialStateOfModule extends BaseClass {
    public GLP_357812_VerifyInitialStateOfModule() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER }, enabled = true,

            description = "Verify that 'Start' button in collapsed state would be displayed when the module has not been started. Also, there should be one module with a Start button at a time.Verify that 'Continue' button in collapsed state would be displayed when any module LO has been started and after login and logout")
    public void verifyStartAndContinueInitialState() {
        startReport(getTestCaseId(),
                "Verify that 'Start' button in collapsed state would be displayed when the module has not been started. Also, there should be one module with a Start button at a time.Verify that 'Continue' button in collapsed state would be displayed when any module LO has been started and after login and logout");
        ...
        try {
            ...
            objGLPLearnerCourseMaterialPage.verifyElementAttributeValue(
                    ...
                    "Verify module Start button is highlighted.");
            ...
            objGLPLearnerCourseMaterialPage.clickOnElement(
                    "CourseMeterialExpandedModuleArrowICon",
                    "Click on Module collapsed arrow.");

            objGLPLearnerCourseMaterialPage.verifyElementAttributeValue(
                    "CourseMaterialStartButton", "class",
                    "pe-btn__primary--btn_large",
                    "Verify the module Continue button of module is highlighted as before logout.");
            ...
            // start button text changed to continue.
            objGLPLearnerCourseMaterialPage.verifyText(
                    "CourseMaterialSecondModuleStartButton",
                    ResourceConfigurations
                            .getProperty("courseMaterialContinueButton"),
                    "Verify second module start button text changed to continue.");
