 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 16.3
 *
 */
public class GLP_350913_VerifyCoreInstructionLo16_3 extends BaseClass {
	public GLP_350913_VerifyCoreInstructionLo16_3() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR }, enabled = true, description = "Verify that Instructor is able to verify core instruction for LO 16.3")
	public void verifyCoreInstructionLo16_3() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 16.3");
		...
		try {
			...
			// Navigate to the EO's of LO 16.3
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("16.3");
