 ...
 *              Questions for LO 13.1
 */
public class GLP_346315_VerifyPreviewQuestionsLo13_1 extends BaseClass {
    public GLP_346315_VerifyPreviewQuestionsLo13_1() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR,
            Groups.HEARTBEAT,Groups.PASSED
    }, enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 13.1")

    public void verifyPreviewQuestionsLO_13_1() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 13.1");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 13.1
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("13.1");
