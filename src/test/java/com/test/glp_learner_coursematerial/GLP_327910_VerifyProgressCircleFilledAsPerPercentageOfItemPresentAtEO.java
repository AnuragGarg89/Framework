 ...
 * 
 */
public class GLP_327910_VerifyProgressCircleFilledAsPerPercentageOfItemPresentAtEO
		extends BaseClass {
	public GLP_327910_VerifyProgressCircleFilledAsPerPercentageOfItemPresentAtEO() {
	}
	...
	public void verifyAnswerShuffilng() {
		...
		try {
			...
			// Verify EO Progress
			objGLPLearnerCourseMaterialPage.verifyTocProgressPercentage();
		}
