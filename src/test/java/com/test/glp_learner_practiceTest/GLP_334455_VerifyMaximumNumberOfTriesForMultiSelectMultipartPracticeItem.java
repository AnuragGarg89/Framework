 ...
 *               of choices- 1" for multiple select multipart practice item
 */

public class GLP_334455_VerifyMaximumNumberOfTriesForMultiSelectMultipartPracticeItem
        extends BaseClass {
    public GLP_334455_VerifyMaximumNumberOfTriesForMultiSelectMultipartPracticeItem() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER }, enabled = true,
            description = "To verify maximum number of tries displayed is equal to number of choices- 1 for multiple select multipart practice item")
    public void verifyLearnerCanAccessViewAnExampleLA() {
        startReport(getTestCaseId(),
                "To verify maximum number of tries displayed is equal to number of choices- 1 for multiple select multipart practice item");
