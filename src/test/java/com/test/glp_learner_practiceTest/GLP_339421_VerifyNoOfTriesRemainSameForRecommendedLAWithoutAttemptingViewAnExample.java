...
public class GLP_339421_VerifyNoOfTriesRemainSameForRecommendedLAWithoutAttemptingViewAnExample
        extends BaseClass {
    public GLP_339421_VerifyNoOfTriesRemainSameForRecommendedLAWithoutAttemptingViewAnExample() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER }, enabled = true,
            description = "Verify number of tries on recommended learning aids remain same without attempting View An Example")
    public void verifyStateOfRecommendedLAOnClosingPracticeTest() {
        startReport(getTestCaseId(),
                "Verify number of tries on recommended learning aids remain same without attempting View An Example");
        ...
        try {
            ...
            // Click on Close icon in the header of View An Example
