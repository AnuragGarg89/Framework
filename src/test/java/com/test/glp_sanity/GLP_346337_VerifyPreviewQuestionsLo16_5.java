 ...
 *              Questions for LO 16.5
 */
public class GLP_346337_VerifyPreviewQuestionsLo16_5 extends BaseClass {
    public GLP_346337_VerifyPreviewQuestionsLo16_5() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR, Groups.HEARTBEAT },
            enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 16.5")
    public void verifyPreviewQuestionsLO_16_5() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 16.5");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 16.5
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("16.5");
