 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 11.1
 *
 */
public class GLP_358020_VerifyCoreInstructionLo11_1 extends BaseClass {
	public GLP_358020_VerifyCoreInstructionLo11_1() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR, Groups.HEARTBEAT }, enabled = true, description = "Verify that Instructor is able to verify core instruction for LO 11.1")
	public void verifyCoreInstructionLo11_1() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 11.1");
		...
		try {
			...
			// Navigate to the EO's of LO 11.1
