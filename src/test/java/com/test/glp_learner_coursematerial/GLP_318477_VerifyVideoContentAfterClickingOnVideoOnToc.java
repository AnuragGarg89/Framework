 ...
 * @date Dec 18, 2017
 * @description: Verify that on On clicking video content in TOC , respective
 *               video content should be displayed on right side of page
 * 
 */
public class GLP_318477_VerifyVideoContentAfterClickingOnVideoOnToc extends
		BaseClass {
	public GLP_318477_VerifyVideoContentAfterClickingOnVideoOnToc() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT, Groups.LEARNER,
			Groups.TOC }, enabled = true, description = "Verify that on On clicking video content in TOC , respective video content should be displayed on right side of page.")
	public void verifyVideoContentAfterClickingOnVideoOnToc() {
		startReport(
				getTestCaseId(),
				"Verify that on On clicking video content in TOC , respective video content should be displayed on right side of page");
		...
		try {
			...
			objGLPLearnerCourseMaterialPage.clickOnElement("SubheadingVideo",
					"Click on SubHeading Video");

			// Verify Video content is available and opened
			objGLPLearnerCourseMaterialPage.verifyElementPresent(
					"VideoContent", "Verify Video content is available.");
