 ...
 *               Sign-In page
 */
public class GLP_280657_VerifyAccessibilityInstructorWelcomePage
        extends BaseClass {
    public GLP_280657_VerifyAccessibilityInstructorWelcomePage() {
        // TODO Auto-generated constructor stub
    }

    @Test(groups = { Groups.REGRESSION, Groups.ACCESSIBILITY, Groups.INSTRUCTOR,
            Groups.NEWCOURSEREQUIRED }, enabled = false,
            description = "Verify Web Content Accessibility Guidelines(WCAG) 2.0 with AA standards for the Instructor Welcome page")

    public void vVerifyAccessibilityInstructorWelcomePage() {
        startReport(getTestCaseId(),
                "Verify Web Content Accessibility Guidelines(WCAG) 2.0 with AA standards for the Instructor Welcome page");
