 ...
 *              Questions for LO 15.5
 */
public class GLP_346332_VerifyPreviewQuestionsLo15_5 extends BaseClass {
    public GLP_346332_VerifyPreviewQuestionsLo15_5() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR, Groups.HEARTBEAT,Groups.PASSED },
            enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 15.5")
    public void verifyPreviewQuestionsLO_15_5() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 15.5");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 15.5
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("15.5");
