 ...
 * @author rashmi.z
 * @date Jan 05, 2018
 * @description: Verify MCQ-SA rendering description on card one
 * 
 */
public class GLP_287318_VerifyMCQSARenderingDescriptionOnCardOne
        extends BaseClass {
    public GLP_287318_VerifyMCQSARenderingDescriptionOnCardOne() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.MCQSA, Groups.LEARNER },
            enabled = true,
            description = "Verify MCQ-SA rendering description on card one")
    public void verifyMCQSARenderingDescriptionOnCardOne() {
        startReport(getTestCaseId(),
                "Verify MCQ-SA rendering description on card one");
