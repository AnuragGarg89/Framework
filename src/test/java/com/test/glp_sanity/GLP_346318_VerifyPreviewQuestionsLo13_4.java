 ...
 *              Questions for LO 13.4
 */
public class GLP_346318_VerifyPreviewQuestionsLo13_4 extends BaseClass {
    public GLP_346318_VerifyPreviewQuestionsLo13_4() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR,
            Groups.HEARTBEAT }, enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 13.4")
    public void verifyPreviewQuestionsLO_13_4() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 13.4");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 13.4
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("13.4");
