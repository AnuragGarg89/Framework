 ...
 *               closing the practice test and reopening it
 */

public class GLP_339427_VerifyStateOfRecommendedLAOnClosingPracticeTest
        extends BaseClass {
    public GLP_339427_VerifyStateOfRecommendedLAOnClosingPracticeTest() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER }, enabled = true,
            description = "Verify state of Recommended Learning Aids on closing the practice test and reopening")
    public void verifyStateOfRecommendedLAOnClosingPracticeTest() {
        startReport(getTestCaseId(),
                "Verify state of Recommended Learning Aids on closing the practice test and reopening");
        ...
        try {
            ...
            objGLPLearnerPracticeTestPage.navigateToDesiredPracticeTest(
                    ...
                    ResourceConfigurations
                            .getProperty("subModule11_2AriaLabel"),
            ...
            // Close the practice assessment player and reopen it
            objGLPLearnerPracticeTestPage.closePracticeTestAndReopen();
