 ...
 *
 */
public class GLP_316115_VerifyPreAssesmentPopUpHideOnCancelButton
        extends BaseClass {
    public GLP_316115_VerifyPreAssesmentPopUpHideOnCancelButton() {
    }

    @Test(groups = { Groups.INSTRUCTOR, Groups.REGRESSION,
            Groups.NEWCOURSEREQUIRED }, enabled = true,
            description = "Verify PreAssessment confirmation pop-up hide when clicked on 'Cancel' button.")
    public void verifyPreAssesmentPopUpHideOnCancelButton()
            throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify PreAssessment confirmation pop-up hide when clicked on 'Cancel' button.");
        ...
        try {
            ...
            // Verify count of 'Lock Selected' button
            objGLPInstructorDashboardPage.verifyText(
                    "InstructorDashBoardLockUnlockCount", "1",
                    "Verify count of 'Lock Selected' button is 1.");
