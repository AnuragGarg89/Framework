 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 13.6
 *
 */
public class GLP_350898_VerifyCoreInstructionLo13_6 extends BaseClass {
	public GLP_350898_VerifyCoreInstructionLo13_6() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR, Groups.HEARTBEAT }, enabled = false, description = "Verify that Instructor is able to verify core instruction for LO 13.6")
	public void verifyCoreInstructionLo13_6() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 13.6");
		...
		try {
			...
			// Navigate to the EO's of LO 13.6
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("13.6");
