 ...
 *              Questions for LO 16.2
 */
public class GLP_346334_VerifyPreviewQuestionsLo16_2 extends BaseClass {
    public GLP_346334_VerifyPreviewQuestionsLo16_2() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR,
            Groups.HEARTBEAT,Groups.PASSED }, enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 16.2")
    public void verifyPreviewQuestionsLO_16_2() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 16.2");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 16.2
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("16.2");
