 ...
 *               standards for the Learner course Home page
 */
public class GLP_280726_VerifyAccessibilityLearnerCourseHomePage
        extends BaseClass {
    public GLP_280726_VerifyAccessibilityLearnerCourseHomePage() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.ACCESSIBILITY, Groups.LEARNER },
            enabled = true,
            description = "Verify Web Content Accessibility Guidelines (WCAG) 2.0 with AA standards for the Learner course Home page")
    public void verifyAccessibilityLearnerCourseHomePage() {
        startReport(getTestCaseId(),
                "Verify Web Content Accessibility Guidelines (WCAG) 2.0 with AA standards for the Learner course Home page");
        try {
