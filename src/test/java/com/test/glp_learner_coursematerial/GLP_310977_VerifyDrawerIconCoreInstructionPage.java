...
public class GLP_310977_VerifyDrawerIconCoreInstructionPage extends BaseClass {
	public GLP_310977_VerifyDrawerIconCoreInstructionPage() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT, Groups.LEARNER,
			Groups.TOC }, enabled = true, description = "To verify that student able to view drawer icon on Core Instruction page")
	public void verifyDrawerIconCoreInstructionPage()
			throws InterruptedException {
		startReport(getTestCaseId(),
				"To verify that student able to view drawer icon on Core Instruction page");
