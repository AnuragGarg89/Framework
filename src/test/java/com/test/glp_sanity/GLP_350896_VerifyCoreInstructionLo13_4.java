 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 13.4
 *
 */
public class GLP_350896_VerifyCoreInstructionLo13_4 extends BaseClass {
	public GLP_350896_VerifyCoreInstructionLo13_4() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR, Groups.HEARTBEAT,Groups.TEST}, enabled = false, description = "Verify that Instructor is able to verify core instruction for LO 13.4")
	public void verifyCoreInstructionLo13_4() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 13.4");
		...
		try {
			...
			// Navigate to the EO's of LO 13.4
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("13.4");
