 ...
 * @date May 8, 2018
 * @description: To verify number of tries displayed for HMST of multipart
 *               practice item
 */

public class GLP_334457_VerifyMaximumNumberOfTriesForHMST extends BaseClass {
    public GLP_334457_VerifyMaximumNumberOfTriesForHMST() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER }, enabled = true,
            description = "To verify number of tries displayed for HMST of multipart practice item")
    public void verifyLearnerCanAccessViewAnExampleLA() {
        startReport(getTestCaseId(),
                "To verify number of tries displayed for HMST of multipart practice item");
