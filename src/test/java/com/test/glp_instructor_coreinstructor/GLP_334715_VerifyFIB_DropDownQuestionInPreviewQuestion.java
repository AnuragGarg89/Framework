...
public class GLP_334715_VerifyFIB_DropDownQuestionInPreviewQuestion
        extends BaseClass {

    public GLP_334715_VerifyFIB_DropDownQuestionInPreviewQuestion() {

    }

    @Test(groups = { Groups.REGRESSION, Groups.INSTRUCTOR }, enabled = true,
            description = "To verify FIB Dropdown questions are displayed in preview mode on Preview Questions")
    public void verifyFIB_DropDownQuestionInPreviewQuestion() {

        startReport(getTestCaseId(),
                "To verify FIB Dropdown questions are displayed in preview mode on Preview Questions");
        ...
        try {
            ...
            // Verify that the Question is of FIB Dropdown type
            objProductCoreInstructionPage.navigateToQuestionType("FIB_Dropdown",
