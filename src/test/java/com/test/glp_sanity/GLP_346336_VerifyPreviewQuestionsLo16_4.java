 ...
 *              Questions for LO 16.4
 */
public class GLP_346336_VerifyPreviewQuestionsLo16_4 extends BaseClass {
    public GLP_346336_VerifyPreviewQuestionsLo16_4() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR, Groups.HEARTBEAT },
            enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 16.4")
    public void verifyPreviewQuestionsLO_16_4() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 16.4");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 16.4
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("16.4");
