 ...
 */
public class GLP_316118_VerifyLockPreAssessmentHidingCharactor
        extends BaseClass {
    public GLP_316118_VerifyLockPreAssessmentHidingCharactor() {
    }
    ...
    public void verifyStudentFilterSortedAsPerSelectionInDropdown()
        ...
        try {
            ...
            objGLPInstructorDashboardPage.clickOnElement(
                    "PerforManceDashBoardPearsonLogo",
                    "Click on 'Pearson Logo' to navigate to console.");
            ...
            objGLPInstructorDashboardPage.verifyElementNotPresent(
                    "PerforManceDashBoardLockPopUpMessage",
                    "Verify Lock pre-assessment confirmation pop up is not displayed after coming again from console.");
            ...
            objGLPInstructorDashboardPage.verifyElementNotPresent(
                    "PerforManceDashBoardLockPopUpMessage",
                    "Verify Lock pre-assessment confirmation pop up is not displayed after coming back from Management to peeformance tab.");
