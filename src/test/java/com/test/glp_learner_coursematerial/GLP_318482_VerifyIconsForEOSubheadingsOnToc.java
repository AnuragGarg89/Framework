 ...
 * @date Dec 18, 2017
 * @description: Verify Icons should display against core instructions in
 *               enabling objective in TOC
 * 
 */
public class GLP_318482_VerifyIconsForEOSubheadingsOnToc extends BaseClass {
	public GLP_318482_VerifyIconsForEOSubheadingsOnToc() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT, Groups.LEARNER,
			Groups.TOC }, enabled = true, description = "Verify Icons should display against core instructions in enabling objective in TOC")
	public void verifyIconsForEOSubheadingsOnToc() {
		startReport(
				getTestCaseId(),
				"Verify Icons should display against core instructions in enabling objective in TOC");
		...
		try {
			...
			objGLPLearnerCourseMaterialPage.verifyElementPresent("", "Verify Module List on course home page");
			...
			// Verify Video content is available and opened
			objGLPLearnerCourseViewPage.verifyElementPresent("SubheadingVideo",
					"Verify Video Icons.");

			// Verify Video content is available and opened
			objGLPLearnerCourseViewPage.verifyElementPresent(
					"SubheadingContent", "Verify Content Icons.");
			// Verify Video content is available and opened
			objGLPLearnerCourseViewPage.verifyElementPresent("SubheadingQuizz",
					"Verify Practice Icons.");

			// Verify Video content is available and opened
			/*
			 * objGLPLearnerCourseViewPage.verifyElementPresent("SubheadingEdit",
			 * "Verify Edit Icons.");
			 */
