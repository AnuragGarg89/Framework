 ...
 * @author rashmi.z
 * @date Feb 12, 2018
 * @description: To Render "Dynamic table without Border.
 * 
 */
public class GLP_306969_VerifyDynamicBorderlessTable extends BaseClass {
    public GLP_306969_VerifyDynamicBorderlessTable() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER }, enabled = false,
            description = "Verify Dynamic table without Border.")
    public void VerifyDynamicBorderlessTable() {
        startReport(getTestCaseId(), "Verify Dynamic table without Border.");
