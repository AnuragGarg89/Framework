...
public class GLP_334714_VerifyMCQMAInPreviewQuestion extends BaseClass {

    public GLP_334714_VerifyMCQMAInPreviewQuestion() {

    }

    @Test(groups = { Groups.REGRESSION, Groups.INSTRUCTOR }, enabled = true,
            description = "To verify MCQMA is displayed in preview mode on Preview Questions")
    public void verifyMCQMAInPreviewQuestion() {

        startReport(getTestCaseId(),
                "To verify MCQMA is displayed in preview mode on Preview Questions");
        ...
        try {
            ...
            // Navigate to MCQMA Question
            objProductCoreInstructionPage.navigateToQuestionType("MCQMA",
                    "Verify MCQMA is displayed in preview mode on Preview Questions");

            // Verify more than 1 answer is displayed for MCQMA type of Question
            objProductCoreInstructionPage.verifyMultipleAnswerForMCQMA();
