 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 14.1
 *
 */
public class GLP_350900_VerifyCoreInstructionLo14_1 extends BaseClass {
	public GLP_350900_VerifyCoreInstructionLo14_1() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR }, enabled = false, description = "Verify that Instructor is able to verify core instruction for LO 14.1")
	public void verifyCoreInstructionLo14_1() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 14.1");
		...
		try {
			...
			// Navigate to the EO's of LO 14.1
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("14.1");
