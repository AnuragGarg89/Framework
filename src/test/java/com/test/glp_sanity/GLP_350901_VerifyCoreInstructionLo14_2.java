 ...
 *
 */
public class GLP_350901_VerifyCoreInstructionLo14_2 extends BaseClass {
    public GLP_350901_VerifyCoreInstructionLo14_2() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.INSTRUCTOR, Groups.HEARTBEAT },
            enabled = false,
            description = "Verify that Instructor is able to verify core instruction for LO 14.2")
    public void verifyCoreInstructionLo14_2() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to verify core instruction for LO 14.2");
        ...
        try {
            ...
            // Navigate to the EO's of LO 14.2
