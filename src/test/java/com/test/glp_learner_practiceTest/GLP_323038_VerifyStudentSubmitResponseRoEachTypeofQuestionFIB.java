 ...
 *               type of question - FIB
 * 
 * 
 * 
 */
public class GLP_323038_VerifyStudentSubmitResponseRoEachTypeofQuestionFIB
        extends BaseClass {
    public GLP_323038_VerifyStudentSubmitResponseRoEachTypeofQuestionFIB() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER, Groups.FIB },
            enabled = true,
            description = "To verify Student should be able to submit response to each type of question - FIB")
    public void verifyStudentSubmitResponseRoEachTypeofQuestionMCQ() {
        startReport(getTestCaseId(),
                "To verify Student should be able to submit response to each type of question - FIB");
