 ...
 * 
 */
public class GLP_334021_VerifyFIBTypeQuestionForCorrectIncorrectAnswer
        extends BaseClass {
    public GLP_334021_VerifyFIBTypeQuestionForCorrectIncorrectAnswer() {
    }
    ...
    public void verifyScreenGreyedOutWhenCoachmarkIsPresent() {
        ...
        try {
            ...
            // String FIBURL =
            // "https://learnerui-qa.gl-poc.com/#/question/Q-I1202027";
            // ---------------------------------------------------------------------------------------------------------------------------------
