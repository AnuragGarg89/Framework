 ...
 * @date March 3, 2018
 * @description : To verify that for practice test the circle progress does not
 *              get updated when the learner has completed the practice test
 *              partially
 * 
 */
public class GLP_327914_VerifyProgressNotCompletedForPartialPracticeTest extends
		BaseClass {
	public GLP_327914_VerifyProgressNotCompletedForPartialPracticeTest() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT, Groups.LEARNER,
			Groups.TOC }, enabled = true, description = "To verify that for practice test the circle progress does not get updated when the learner has completed the practice test partially")
	public void verifyProgressNotCompletedForPartialPracticeTest() {
		startReport(
				getTestCaseId(),
				"To verify that for practice test the circle progress does not get updated when the learner has completed the practice test partially");
		...
		try {
			...
			// Progress before Practice Test
			String beforeTest = objGLPLearnerCourseMaterialPage
					.getActualEoProgressValue();

			// Click on Practice Test
			objGLPLearnerCourseMaterialPage.clickOnElement("SubheadingQuizz",
					"Click on Pratice Test.");
			...
			String afterTest = objGLPLearnerCourseMaterialPage
					.getActualEoProgressValue();

			objGLPLearnerCourseMaterialPage.compareText(beforeTest, afterTest);
