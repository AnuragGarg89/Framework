 ...
 * @date Dec 06, 2017
 * @description: Verify that Pre-Assessment exit confirmation popup on FIB
 *               Dropdown question appears in Arabic - Saudi Arabia text
 *               language
 */
public class GLP_283817_VerifyDiagnosticExitConfirmationPopupOnFIBDropdownLocalization
        extends BaseClass {
    public GLP_283817_VerifyDiagnosticExitConfirmationPopupOnFIBDropdownLocalization() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT, Groups.LEARNER },
            enabled = false,
            description = "Verify that Pre-Assessment exit confirmation popup on FIB Dropdown question appears in Arabic - Saudi Arabia text language")
    public void verifyDiagnosticLabelAndTextLocalization() {
        startReport(getTestCaseId(),
                "Verify that Pre-Assessment exit confirmation popup on FIB Dropdown question appears in Arabic - Saudi Arabia text language");
