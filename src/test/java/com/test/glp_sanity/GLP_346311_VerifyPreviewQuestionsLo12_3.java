 ...
 *              Questions for LO 12.3
 */
public class GLP_346311_VerifyPreviewQuestionsLo12_3 extends BaseClass {
    public GLP_346311_VerifyPreviewQuestionsLo12_3() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR,
            Groups.HEARTBEAT, Groups.PASSED }, enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 12.3")
    public void verifyPreviewQuestionsLO_12_3() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 12.3");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 12.3
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("12.3");
