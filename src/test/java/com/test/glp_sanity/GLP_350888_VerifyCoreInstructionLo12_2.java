 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO
 *              12.2
 *
 */
public class GLP_350888_VerifyCoreInstructionLo12_2 extends BaseClass {
    public GLP_350888_VerifyCoreInstructionLo12_2() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR,
            Groups.HEARTBEAT, Groups.TEST, Groups.BUGS }, enabled = true,
            description = "Verify that Instructor is able to verify core instruction for LO 12.2")
    public void verifyCoreInstructionLo12_2() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to verify core instruction for LO 12.2");
        ...
        try {
            ...
            // Navigate to the EO's of LO 12.2
