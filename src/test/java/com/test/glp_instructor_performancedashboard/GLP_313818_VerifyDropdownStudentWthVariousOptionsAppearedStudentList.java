 ...
 * @date Mar 12, 2018
 * @description : To verify dropdown student with various options is appeared in
 *              student list on performance tab
 * 
 */
public class GLP_313818_VerifyDropdownStudentWthVariousOptionsAppearedStudentList
        extends BaseClass {
    public GLP_313818_VerifyDropdownStudentWthVariousOptionsAppearedStudentList() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.INSTRUCTOR,
            Groups.NEWCOURSEREQUIRED }, enabled = true,
            description = "To verify dropdown student with various options is appeared in student list on performance tab")
    public void
           VerifyFirstNonMasteredCircleIconDividedIntoSmallLinesEqualsToNumberOfLOsPresent()
                   throws InterruptedException {
        startReport(getTestCaseId(),
                "To verify dropdown student with various options is appeared in student list on performance tab");
