 ...
 *              Questions for LO 12.2
 */
public class GLP_346310_VerifyPreviewQuestionsLo12_2 extends BaseClass {
    public GLP_346310_VerifyPreviewQuestionsLo12_2() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR,
            Groups.HEARTBEAT }, enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 12.2")
    public void verifyPreviewQuestionsLO_12_2() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 12.2");
