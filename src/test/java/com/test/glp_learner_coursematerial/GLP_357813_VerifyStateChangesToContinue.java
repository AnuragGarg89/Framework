 ...
 *              displayed when first LO of the module is in not started state
 *              and other LOs are completed. Also, there can be multiple modules
 *              with a Continue button.
 * 
 */
public class GLP_357813_VerifyStateChangesToContinue extends BaseClass {
    public GLP_357813_VerifyStateChangesToContinue() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER }, enabled = true,

            description = "Verify that 'Continue' button in collapsed state would be displayed when first LO of the module is in not started state and other LOs are completed. Also, there can be multiple modules with a Continue button.")
    public void verifyStartAndContinueInitialState() {
        startReport(getTestCaseId(),
                "Verify that 'Continue' button in collapsed state would be displayed when first LO of the module is in not started state and other LOs are completed. Also, there can be multiple modules with a Continue button.");
