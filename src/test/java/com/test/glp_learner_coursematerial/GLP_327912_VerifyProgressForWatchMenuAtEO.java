 ...
 * @date March 2, 2018
 * @description :To verify that circle progress updated by navigating to "Watch"
 *              type menu item and its detail page opens
 * 
 */
public class GLP_327912_VerifyProgressForWatchMenuAtEO extends BaseClass {
	public GLP_327912_VerifyProgressForWatchMenuAtEO() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT, Groups.LEARNER,
			Groups.TOC }, enabled = true, description = "To verify that circle progress updated by navigating to Watch type menu item and its detail page opens")
	public void verifyProgressForWatchMenuAtEO() {
		startReport(
				getTestCaseId(),
				"To verify that circle progress updated by navigating to Watch type menu item and its detail page opens");
		...
		try {
			...
			String beforevalue = objGLPLearnerCourseMaterialPage
