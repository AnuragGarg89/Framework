 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 15.5
 *
 */
public class GLP_350910_VerifyCoreInstructionLo15_5 extends BaseClass {
	public GLP_350910_VerifyCoreInstructionLo15_5() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR }, enabled = false, description = "Verify that Instructor is able to verify core instruction for LO 15.5")
	public void verifyCoreInstructionLo15_5() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 15.5");
		...
		try {
			...
			// Navigate to the EO's of LO 15.5
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("15.5");
