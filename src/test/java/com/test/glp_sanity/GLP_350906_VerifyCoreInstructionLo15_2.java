 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 15.2
 *
 */
public class GLP_350906_VerifyCoreInstructionLo15_2 extends BaseClass {
	public GLP_350906_VerifyCoreInstructionLo15_2() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR }, enabled = true, description = "Verify that Instructor is able to verify core instruction for LO 15.2")
	public void verifyCoreInstructionLo15_2() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 15.2");
		...
		try {
			...
			// Navigate to the EO's of LO 15.2
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("15.2");
