 ...
 * 
 */
public class GLP_xxxxx3_VerifyInitialStateOfModule extends BaseClass {
    public GLP_xxxxx3_VerifyInitialStateOfModule() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER }, enabled = true,

            description = "Verify that 'Continue' button in collapsed state would be displayed when second LO of teh module has been started and rest other LOs are in not started state.")
    public void verifyStartAndContinueInitialState() {
        startReport(getTestCaseId(),
                "Verify that 'Continue' button in collapsed state would be displayed when second LO of teh module has been started and rest other LOs are in not started state.");
