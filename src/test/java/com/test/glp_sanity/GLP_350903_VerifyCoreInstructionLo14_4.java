 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 14.4
 *
 */
public class GLP_350903_VerifyCoreInstructionLo14_4 extends BaseClass {
	public GLP_350903_VerifyCoreInstructionLo14_4() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR }, enabled = false, description = "Verify that Instructor is able to verify core instruction for LO 14.4")
	public void verifyCoreInstructionLo14_4() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 14.4");
		...
		try {
			...
			// Navigate to the EO's of LO 14.4
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("14.4");
