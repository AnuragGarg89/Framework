 ...
 * @date April 1, 2018
 * @description: "Verify 'Unlock PreAssessment Test' pop-up hide when instructor
 *               logoff."
 *
 */
public class GLP_316696_VerifyPreAssesmentPopUpHideWhenInstructorSignOff
        extends BaseClass {
    public GLP_316696_VerifyPreAssesmentPopUpHideWhenInstructorSignOff() {
    }

    @Test(groups = { Groups.INSTRUCTOR, Groups.REGRESSION,
            Groups.NEWCOURSEREQUIRED }, enabled = true,
            description = "Verify 'Unlock PreAssessment Test' pop-up hide when instructor logoff.")
    public void verifyPreAssesmentPopUpHideWhenInstructorSignOff()
            throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify 'Unlock PreAssessment Test' pop-up hide when instructor logoff.");
        ...
        try {
            ...
            // Verify 'PreAssessment pop-up' is not present on UI after
            // instructor logoff
            objGLPInstructorDashboardPage.verifyElementNotPresent(
                    "UnlockPreAssessmentTest",
                    "Verify 'PreAssessment pop-up is not present on UI after instructor logoff.");
            ...
            // Verify 'PreAssessment pop-up' is not present on UI
            objGLPInstructorDashboardPage.verifyElementNotPresent(
                    "UnlockPreAssessmentTest",
                    "Verify 'PreAssessment pop-up is not present on UI.");
