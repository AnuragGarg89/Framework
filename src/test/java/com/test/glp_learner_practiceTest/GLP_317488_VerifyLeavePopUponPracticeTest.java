 ...
 * @author lekh.bahl
 * @date March 19, 2018
 * @description: Test to verify that Pop up Message should be displayed on
 *               clicking the cross icon on practice test.
 * 
 */
public class GLP_317488_VerifyLeavePopUponPracticeTest extends BaseClass {
    public GLP_317488_VerifyLeavePopUponPracticeTest() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER }, enabled = true,
            description = "Test to verify that Pop up Message should be displayed on clicking the cross icon on practice test")
    public void VerifyLeavePopUpOnPracticeTest() {
        startReport(getTestCaseId(),
                "Test to verify that Pop up Message should be displayed on clicking the cross icon on practice test.");
