 ...
 *              Questions for LO 15.3
 */
public class GLP_346330_VerifyPreviewQuestionsLo15_3 extends BaseClass {
    public GLP_346330_VerifyPreviewQuestionsLo15_3() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR, Groups.HEARTBEAT,Groups.PASSED },
            enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 15.3")
    public void verifyPreviewQuestionsLO_15_3() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 15.3");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 15.3
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("15.3");
