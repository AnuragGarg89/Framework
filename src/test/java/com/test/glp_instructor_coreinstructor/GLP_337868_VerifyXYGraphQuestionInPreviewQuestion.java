...
public class GLP_337868_VerifyXYGraphQuestionInPreviewQuestion
        extends BaseClass {

    public GLP_337868_VerifyXYGraphQuestionInPreviewQuestion() {

    }

    @Test(groups = { Groups.REGRESSION, Groups.INSTRUCTOR }, enabled = true,
            description = "To verify XY graph questions are displayed in preview mode on Preview Questions")
    public void verifyXYGraphQuestionInPreviewQuestion() {

        startReport(getTestCaseId(),
                "To verify XY graph questions are displayed in preview mode on Preview Questions");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 12.1
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("12.1");

            // Verify that the Question is of Free Response type
            objProductCoreInstructionPage.navigateToQuestionType("XYGraph",
                    "Verify that XY graph Question is Displayed");
