 ...
 * @author lekh.bahl
 * @date March 29, 2018
 * @description: Validate that progress bar should be increased in forward
 *               direction.
 * 
 */
public class GLP_317265_VerifyProressBarIncrementInPracticeTest
        extends BaseClass {
    public GLP_317265_VerifyProressBarIncrementInPracticeTest() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER }, enabled = true,
            description = "Validate that progress bar should be increased in forward direction")
    public void VerifyProgressBarIncrementPracticeTest() {
        startReport(getTestCaseId(),
                "Validate that progress bar should be increased in forward direction");
