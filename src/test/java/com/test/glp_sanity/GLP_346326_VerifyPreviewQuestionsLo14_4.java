 ...
 *              Questions for LO 14.4
 */
public class GLP_346326_VerifyPreviewQuestionsLo14_4 extends BaseClass {
    public GLP_346326_VerifyPreviewQuestionsLo14_4() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR, Groups.HEARTBEAT,Groups.PASSED },
            enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 14.4")
    public void verifyPreviewQuestionsLO_14_4() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 14.4");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 14.4
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("14.4");
