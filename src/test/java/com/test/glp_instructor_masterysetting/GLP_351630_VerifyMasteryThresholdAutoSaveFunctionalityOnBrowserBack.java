 ...
 *              away from the page.
 */
public class GLP_351630_VerifyMasteryThresholdAutoSaveFunctionalityOnBrowserBack
		extends BaseClass {
	public GLP_351630_VerifyMasteryThresholdAutoSaveFunctionalityOnBrowserBack() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.INSTRUCTOR,
			Groups.NEWCOURSEREQUIRED }, enabled = true, description = "Verify that the threshold value added by the instructor on Pre- Assessment mastery setup page is auto-saved on navigating away from the page")
