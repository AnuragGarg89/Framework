 ...
 *               links of HMST in Browser selected language
 */

public class GLP_328223_VerifyHMSTTextIsDisplayedInBrowserSelectedLanguage
        extends BaseClass {
    public GLP_328223_VerifyHMSTTextIsDisplayedInBrowserSelectedLanguage() {
    }
    ...
    public void verifyLearnerCanAccessHMSTLA() {
        startReport(getTestCaseId(),
                "Verify that application should display all buttons/ navigation links of HMST in Browser selected language");
        ...
        try {
            ...
            // Verify the text of Help Me Solve This option is in browser
            // selected language
            sLocalizedText = objGLPLearnerPracticeTestPage
                    .getText("HelpMeSolveThisLAOption");
            objGLPLearnerPracticeTestPage.verifyLocalizedText(
                    ResourceConfigurations
                            .getProperty("learningAidsHelpMeSolveThis"),
                    sLocalizedText, "Help Me Solve This option");
            // Click on Help Me Answer This drop down
            objGLPLearnerPracticeTestPage.clickOnElement(
                    "HelpMeAnswerThisDropdown",
                    "Click on Help Me Answer This dropdown");
            ...
            // Verify the text of Submit button is in browser
            // selected language
            sLocalizedText = objGLPLearnerPracticeTestPage
                    .getText("LearningAidsSubmitPartButton");
            objGLPLearnerPracticeTestPage.verifyLocalizedText(
                    ResourceConfigurations.getProperty("submitButtonText"),
                    sLocalizedText, "Submit button");
            // Attempt all remaining parts of Help Me Solve This
            objGLPLearnerPracticeTestPage.attemptStudentInitiatedLA(
                    interactivePartIndex, totalParts);
