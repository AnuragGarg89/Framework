 ...
 * @date Mar 12, 2018
 * @description :To verify that Student First Name, LastName along with Email id
 *              should be displayed in "Name" column
 * 
 */
public class GLP_313928_VerifyStudentNameAndEmailIDIsDisplayed
        extends BaseClass {
    public GLP_313928_VerifyStudentNameAndEmailIDIsDisplayed() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.INSTRUCTOR }, enabled = true,
            description = "To verify that Student First Name, LastName along with Email id should be displayed in Name column")
    public void verifyStudentNameAndEmailIDIsDisplayed()
            throws InterruptedException {
        startReport(getTestCaseId(),
                "To verify that Student First Name, LastName along with Email id should be displayed in Name column");
        ...
        try {
            ...
            objProductApplicationInstructorDashboardPage.verifyElementPresent(
                    ...
                    "Learner 'user name' is present");
            objProductApplicationInstructorDashboardPage.verifyElementPresent(
                    "InstructorDashBoardPerformanceEmailID",
                    "Learner 'email' is present");
