 ...
 *
 */
public class GLP_350894_VerifyCoreInstructionLo13_2 extends BaseClass {
    public GLP_350894_VerifyCoreInstructionLo13_2() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR,
            Groups.HEARTBEAT}, enabled = false,
            description = "Verify that Instructor is able to verify core instruction for LO 13.2")
    public void verifyCoreInstructionLo13_1() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to verify core instruction for LO 13.2");
        ...
        try {
            ...
            // Navigate to the EO's of LO 13.2
