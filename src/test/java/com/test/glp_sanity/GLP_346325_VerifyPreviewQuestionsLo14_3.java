 ...
 *              Questions for LO 14.3
 */
public class GLP_346325_VerifyPreviewQuestionsLo14_3 extends BaseClass {
    public GLP_346325_VerifyPreviewQuestionsLo14_3() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR, Groups.HEARTBEAT },
            enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 14.3")
    public void verifyPreviewQuestionsLO_14_3() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 14.3");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 14.3
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("14.3");
