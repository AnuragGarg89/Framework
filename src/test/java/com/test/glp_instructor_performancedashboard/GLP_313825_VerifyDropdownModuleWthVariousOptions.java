 ...
 * @date Mar 12, 2018
 * @description :To verify Content dropdown is available and showing All modules
 *              and Pre-assessment option in dropdown.
 */
public class GLP_313825_VerifyDropdownModuleWthVariousOptions
        extends BaseClass {
    public GLP_313825_VerifyDropdownModuleWthVariousOptions() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.INSTRUCTOR }, enabled = true,
            description = "To verify Content dropdown is available and showing All modules and Pre-assessment option in dropdown.")
    public void verifyDropdownModuleWthVariousOptions()
            throws InterruptedException {
        startReport(getTestCaseId(),
                "To verify Content dropdown is available and showing All modules and Pre-assessment option in dropdown.");
        try {
