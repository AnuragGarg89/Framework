 ...
 * @date Dec 18, 2017
 * @description: Verify that Content should be updated on selecting Arrow button
 *               for traversing or selecting any other sub heading in TOC.
 * 
 */
public class GLP_318484_VerifyContentUpdateAfterClickingOnArrowButton extends
		BaseClass {
	public GLP_318484_VerifyContentUpdateAfterClickingOnArrowButton() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT, Groups.LEARNER,
			Groups.TOC }, enabled = true, description = "Verify that Content should be updated on selecting Arrow button for traversing or selecting any other sub heading in TOC.")
	public void verifyContentUpdateAfterClickingOnArrowButton() {
		startReport(
				getTestCaseId(),
				"Verify that Content should be updated on selecting Arrow button for traversing or selecting any other sub heading in TOC.");
		...
		try {
			...
			objGLPLearnerCourseMaterialPage
					.verifyElementPresent("EODetailPageNextArrow",
							"Verify EO Detail Page Next Arrow");

			// Click on Right Arrow
			objGLPLearnerCourseMaterialPage.clickOnElement(
					"EODetailPageNextArrow", "Click EO Detail Page Next Arrow");
