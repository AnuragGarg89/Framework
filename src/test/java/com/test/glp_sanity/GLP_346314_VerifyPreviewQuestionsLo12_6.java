 ...
 *              Questions for LO 12.6
 */
public class GLP_346314_VerifyPreviewQuestionsLo12_6 extends BaseClass {
    public GLP_346314_VerifyPreviewQuestionsLo12_6() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR, Groups.HEARTBEAT },
            enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 12.6")
    public void verifyPreviewQuestionsLO_12_6() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 12.6");
