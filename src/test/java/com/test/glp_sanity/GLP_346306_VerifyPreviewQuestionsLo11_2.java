 ...
 *              Questions for LO 11.2
 */
public class GLP_346306_VerifyPreviewQuestionsLo11_2 extends BaseClass {
    public GLP_346306_VerifyPreviewQuestionsLo11_2() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR,
            Groups.HEARTBEAT }, enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 11.2")
    public void verifyPreviewQuestionsLO_11_2() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 11.2");
