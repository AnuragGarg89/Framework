...
public class GLP_338964_VerifyCallAndResponseQuestionInPreviewQuestion
        extends BaseClass {

    public GLP_338964_VerifyCallAndResponseQuestionInPreviewQuestion() {

    }

    @Test(groups = { Groups.REGRESSION, Groups.INSTRUCTOR }, enabled = true,
            description = "To verify call and response based questions are displayed in preview mode on Preview Questions")
    public void verifyCallAndResponseQuestionInPreviewQuestion() {

        startReport(getTestCaseId(),
                "To verify call and response based questions are displayed in preview mode on Preview Questions");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 12.6
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("12.6");

            // Verify that the Question is of CallAndResponse type
            objProductCoreInstructionPage.navigateToQuestionType(
                    "CallAndResponse",
                    "Verify that Call And Response Question is Displayed");
