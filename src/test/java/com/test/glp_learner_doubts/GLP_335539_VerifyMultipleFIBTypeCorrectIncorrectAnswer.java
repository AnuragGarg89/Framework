 ...
 * 
 */
public class GLP_335539_VerifyMultipleFIBTypeCorrectIncorrectAnswer
        extends BaseClass {
    public GLP_335539_VerifyMultipleFIBTypeCorrectIncorrectAnswer() {
    }
    ...
    public void verifyScreenGreyedOutWhenCoachmarkIsPresent() {
        ...
        try {
            ...
            objProductApplication_DiagnosticTestPage
                    .navigateToActivityType(ResourceConfigurations
                            .getProperty("fibDropDownTableActivity"));
            logResultInReport(
                    Constants.PASS + ": Multiple FIB type question is seen.",
                    "Verify Multiple FIB type question .", this.reportTestObj);
            // ---------------------------------------------------------------------------------------------------------------------------------
