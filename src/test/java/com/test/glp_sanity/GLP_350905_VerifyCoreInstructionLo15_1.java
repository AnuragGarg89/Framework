 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 15.1
 *
 */
public class GLP_350905_VerifyCoreInstructionLo15_1 extends BaseClass {
	public GLP_350905_VerifyCoreInstructionLo15_1() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR }, enabled = false, description = "Verify that Instructor is able to verify core instruction for LO 15.1")
	public void verifyCoreInstructionLo15_1() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 15.1");
		...
		try {
			...
			// Navigate to the EO's of LO 15.1
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("15.1");
