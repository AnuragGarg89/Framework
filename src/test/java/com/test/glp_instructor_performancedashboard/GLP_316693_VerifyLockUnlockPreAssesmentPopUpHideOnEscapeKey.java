 ...
 * @date March 30, 2018
 * @description: Verify Lock/Unlock PreAssessment confirmation pop-up hide when
 *               clicked 'Escape' key
 *
 */
public class GLP_316693_VerifyLockUnlockPreAssesmentPopUpHideOnEscapeKey
        extends BaseClass {
    public GLP_316693_VerifyLockUnlockPreAssesmentPopUpHideOnEscapeKey() {
    }

    @Test(groups = { Groups.INSTRUCTOR, Groups.REGRESSION,
            Groups.NEWCOURSEREQUIRED }, enabled = true,
            description = "Verify Lock/Unlock PreAssessment confirmation pop-up hide when clicked 'Escape' key.")
    public void verifyLockUnlockPreAssesmentPopUpHideOnEscapeKey()
            throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify Lock/Unlock PreAssessment confirmation pop-up hide when clicked 'Escape' key.");
        ...
        try {
            ...
            // Click on 'Escape' key
            objGLPInstructorDashboardPage.pressEscapeKey();

            // Verify 'Unlock PreAssessment' pop-up hides when clicked on
            // 'Escape' key
            objGLPInstructorDashboardPage.verifyElementNotPresent(
                    "UnlockPreAssessmentTest",
                    "Verify 'Unlock PreAssessment' pop-up hides when clicked on 'Escape' key");
            ...
            // Verify 'Lock PreAssessment' pop-up hides when clicked on 'Escape'
            // key
            objGLPInstructorDashboardPage.verifyElementNotPresent(
                    "UnlockPreAssessmentTest",
                    "Verify 'Lock PreAssessment' pop-up hides when clicked on 'Escape' key");
