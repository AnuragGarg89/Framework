 ...
 *               type of question - MCQMA
 * 
 * 
 * 
 */
public class GLP_323037_VerifyStudentSubmitResponseRoEachTypeofQuestionMCQMA
        extends BaseClass {
    public GLP_323037_VerifyStudentSubmitResponseRoEachTypeofQuestionMCQMA() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER, Groups.MCQMA },
            enabled = true,
            description = "To verify Student should be able to submit response to each type of question - MCQMA")
    public void verifyStudentSubmitResponseRoEachTypeofQuestionMCQ() {
        startReport(getTestCaseId(),
                "To verify Student should be able to submit response to each type of question - MCQMA");
