 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 12.4
 *
 */
public class GLP_350890_VerifyCoreInstructionLo12_4 extends BaseClass {
	public GLP_350890_VerifyCoreInstructionLo12_4() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR, Groups.HEARTBEAT }, enabled = true, description = "Verify that Instructor is able to verify core instruction for LO 12.4")
	public void verifyCoreInstructionLo12_4() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 12.4");
		...
		try {
			...
			// Navigate to the EO's of LO 12.4
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("12.4");
