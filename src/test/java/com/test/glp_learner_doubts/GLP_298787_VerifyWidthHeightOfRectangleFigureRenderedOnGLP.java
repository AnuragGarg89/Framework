 ...
 * @author rashmi.z
 * @date Jan 22, 2018
 * @description: To verify rectangle figure rendered on GLP UI has Width and
 *               Height defined by Content Author.
 * 
 */
public class GLP_298787_VerifyWidthHeightOfRectangleFigureRenderedOnGLP
        extends BaseClass {
    public GLP_298787_VerifyWidthHeightOfRectangleFigureRenderedOnGLP() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.FIGURE, Groups.LEARNER },
            enabled = false,
            description = "Verify rectangle figure rendered on GLP UI has Width and Height defined by Content Author.")
    public void VerifyWidthHeightOfRectangleFigureRenderedOnGLP() {
        startReport(getTestCaseId(),
                "Verify rectangle figure rendered on GLP UI has Width and Height defined by Content Author.");
        ...
        try {
            ...
            objProductApplication_DiagnosticTestPage
                    .verifyHeighttWidthForRendringFigures();
