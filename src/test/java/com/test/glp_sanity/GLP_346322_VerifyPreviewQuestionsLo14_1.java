 ...
 *              Questions for LO 14.1
 */
public class GLP_346322_VerifyPreviewQuestionsLo14_1 extends BaseClass {
    public GLP_346322_VerifyPreviewQuestionsLo14_1() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR, Groups.HEARTBEAT },
            enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 14.1")
    public void verifyPreviewQuestionsLO_14_1() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 14.1");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 14.1
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("14.1");
