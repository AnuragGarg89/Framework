 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 12.1
 *
 */
public class GLP_350887_VerifyCoreInstructionLo12_1 extends BaseClass {
	public GLP_350887_VerifyCoreInstructionLo12_1() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR, Groups.HEARTBEAT }, enabled = true, description = "Verify that Instructor is able to verify core instruction for LO 12.1")
	public void verifyCoreInstructionLo12_1() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 12.1");
		...
		try {
			...
			// Navigate to the EO's of LO 12.1
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("12.1");
