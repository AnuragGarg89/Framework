 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 11.3
 *
 */
public class GLP_350885_VerifyCoreInstructionLo11_3 extends BaseClass {
	public GLP_350885_VerifyCoreInstructionLo11_3() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR, Groups.HEARTBEAT }, enabled = true, description = "Verify that Instructor is able to verify core instruction for LO 11.3")
	public void verifyCoreInstructionLo11_3() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 11.3");
		...
		try {
			...
			// Navigate to the Eo's of LO 11.3
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("11.3");
