 ...
 * @author rashmi.z
 * @date Jan 25, 2018
 * @description: To verify Learner is not able to right-click - download figure.
 * 
 */
public class GLP_298790_VerifyRightclickForRectangleFigureDownloadfigure
        extends BaseClass {
    public GLP_298790_VerifyRightclickForRectangleFigureDownloadfigure() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.FIGURE, Groups.LEARNER },
            enabled = false,
            description = "Verify Learner is not able to right-click - download figure")
    public void VerifyRightclickForRectangleFigureDownloadfigure() {
        startReport(getTestCaseId(),
                "Verify Learner is not able to right-click - download figure");
        ...
        try {
            ...
            objProductApplication_DiagnosticTestPage
                    .verifyRightClickForRendringFigures();
