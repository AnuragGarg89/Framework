...
public class GLP_339253_VerifyTableBasedQuestionInPreviewQuestion
        extends BaseClass {

    public GLP_339253_VerifyTableBasedQuestionInPreviewQuestion() {

    }

    @Test(groups = { Groups.REGRESSION, Groups.INSTRUCTOR }, enabled = true,
            description = "To verify table based questions are displayed in preview mode on Preview Questions")
    public void verifyTableBasedQuestionInPreviewQuestion() {

        startReport(getTestCaseId(),
                "To verify table based questions are displayed in preview mode on Preview Questions");
        ...
        try {
            ...
            // Navigate to table based Question
            objProductCoreInstructionPage.navigateToQuestionType("Table",
                    "Verify that Table Based Question is Displayed");
