 ...
 * @date March 2, 2018
 * @description : To verify that "progress" on EO circle should get updated as
 *              soon as student click on the EO menu item and target content is
 *              rendered on right side of screen
 * 
 */
public class GLP_327907_VerifyTOCProgressAndContentOnRightSide extends
		BaseClass {
	public GLP_327907_VerifyTOCProgressAndContentOnRightSide() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT, Groups.LEARNER,
			Groups.TOC }, enabled = true, description = "To verify that progress on EO circle should get updated as soon as student click on the EO menu item and target content is rendered on right side of screen")
	public void verifyAnswerShuffilng() {
		startReport(
				getTestCaseId(),
				"To verify that progress on EO circle should get updated as soon as student click on the EO menu item and target content is rendered on right side of screen");
		...
		try {
			...
			// Verify Element on Right Side
			objGLPLearnerCourseMaterialPage.verifyElementPresent(
					"ContentHeading",
					"Verify content displayed on right side of the TOC");
