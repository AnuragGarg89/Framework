 ...
 *               standards for the dignosist: MCQ_MA question page
 */
public class GLP_283572_VerifyAccessibilityLearnerDiagnosticMCQ_MAPage
        extends BaseClass {
    public GLP_283572_VerifyAccessibilityLearnerDiagnosticMCQ_MAPage() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.ACCESSIBILITY, Groups.LEARNER },
            enabled = true,
            description = "Verify Web Content Accessibility Guidelines (WCAG) 2.0 with AA standards for the dignosist: MCQ_MA question page")
    public void verifyAccessibilityLearnerDiagnosticMCQ_MAPage() {
        startReport(getTestCaseId(),
                "Verify Web Content Accessibility Guidelines (WCAG) 2.0 with AA standards for the dignosist: MCQ_MA question page");
