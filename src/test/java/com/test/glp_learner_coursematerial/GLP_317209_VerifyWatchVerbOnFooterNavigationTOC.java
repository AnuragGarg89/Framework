 ...
 * @date Dec 18, 2017
 * @description: To verify "Watch" verb will be available and used for video
 *               content sub-heading, at arrow label at footer navigation based
 *               on target content type to be rendered
 * 
 */
public class GLP_317209_VerifyWatchVerbOnFooterNavigationTOC extends BaseClass {
	public GLP_317209_VerifyWatchVerbOnFooterNavigationTOC() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT, Groups.LEARNER,
			Groups.TOC }, enabled = true, description = "To verify Watch verb will be available and used for video content sub-heading, at arrow label at footer navigation based on target content type to be rendered ")
	public void verifyWatchVerbOnFooterNavigationTOC() {
		startReport(
				getTestCaseId(),
				"To verify Watch verb will be available and used for video content sub-heading, at arrow label at footer navigation based on target content type to be rendered ");
		...
		try {
			...
			objGLPLearnerCourseMaterialPage.VerifyFooterVerbs("video", "Watch");
		} finally {
