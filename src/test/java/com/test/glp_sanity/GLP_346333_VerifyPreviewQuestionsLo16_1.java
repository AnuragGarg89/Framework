 ...
 *              Questions for LO 16.1
 */
public class GLP_346333_VerifyPreviewQuestionsLo16_1 extends BaseClass {
    public GLP_346333_VerifyPreviewQuestionsLo16_1() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR, Groups.HEARTBEAT },
            enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 16.1")
    public void verifyPreviewQuestionsLO_16_1() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 16.1");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 16.1
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("16.1");
