 ...
 * @date March 2, 2018
 * @description : To verify the color of Collapse/Expanded EO in case of EO is
 *              collapse/expanded respectively
 * 
 */
public class GLP_327915_VerifyProgressAndColourOfCollapsedEO extends BaseClass {
	public GLP_327915_VerifyProgressAndColourOfCollapsedEO() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT, Groups.LEARNER,
			Groups.TOC }, enabled = true, description = "To verify the color of Collapse/Expanded EO in case of EO is collapse/expanded respectively")
	public void verifyProgressShownAtEOLevel() {
		startReport(
				getTestCaseId(),
				"To verify the color of Collapse/Expanded EO in case of EO is collapse/expanded respectively");
		...
		try {
			...
			objGLPLearnerCourseMaterialPage.clickOnElement("EoListTwo",
					"Click on First EO button");
			// Verify EO Progress and Color
			objGLPLearnerCourseMaterialPage.verifyElementPresent("EOGreyColor",
					"Verify the color of progress bar after collapse");
