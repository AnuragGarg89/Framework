 ...
 * @date March 2, 2018
 * @description : To verify that EO circle (circle area on top left corner of
 *              TOC) will be filled as student will progress through core
 *              instruction (navigate through EO Menu items in TOC.) .
 * 
 */
public class GLP_327904_VerifyProgressOnEOAfterClickingOnNextMenu extends
		BaseClass {
	public GLP_327904_VerifyProgressOnEOAfterClickingOnNextMenu() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT, Groups.LEARNER,
			Groups.TOC }, enabled = true, description = "To verify that EO circle (circle area on top left corner of TOC) will be filled as student will progress through core instruction (navigate through EO Menu items in TOC.) .")
	public void verifyProgressOnEOAfterClickingOnNextMenu() {
		startReport(
				getTestCaseId(),
				"To verify that EO circle (circle area on top left corner of TOC) will be filled as student will progress through core instruction (navigate through EO Menu items in TOC.) .");
		...
		try {
			...
			objGLPLearnerCourseMaterialPage.verifyEOProgressOnCircle();
		}
