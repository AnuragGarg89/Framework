 ...
 *              Questions for LO 16.7
 */
public class GLP_346339_VerifyPreviewQuestionsLo16_7 extends BaseClass {
    public GLP_346339_VerifyPreviewQuestionsLo16_7() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR, Groups.HEARTBEAT, Groups.TEST, Groups.BVT },
            enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 16.7")
    public void verifyPreviewQuestionsLO_16_7() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 16.7");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 16.7
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("16.7");
