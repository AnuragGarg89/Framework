 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 13.5
 *
 */
public class GLP_350897_VerifyCoreInstructionLo13_5 extends BaseClass {
	public GLP_350897_VerifyCoreInstructionLo13_5() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR, Groups.HEARTBEAT,Groups.TEST}, enabled = false, description = "Verify that Instructor is able to verify core instruction for LO 13.5")
	public void verifyCoreInstructionLo13_5() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 13.5");
		...
		try {
			...
			// Navigate to the EO's of LO 13.5
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("13.5");
