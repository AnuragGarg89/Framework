 ...
 *               of choices- 1" for FIB question displayed on HMST
 */

public class GLP_334469_VerifyNumberOfTriesIsDisplayedForFIBInHMST
        extends BaseClass {
    public GLP_334469_VerifyNumberOfTriesIsDisplayedForFIBInHMST() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER }, enabled = true,
            description = "To verify maximum number of tries displayed is equal to number of choices- 1 for FIB question displayed on HMST")
    public void verifyNumberOfTriesIsDisplayedForFIBInHMST() {
        startReport(getTestCaseId(),
                "To verify maximum number of tries displayed is equal to number of choices- 1 for FIB question displayed on HMST");
