 ...
 * @date Dec 18, 2017
 * @description: Verify that on On clicking Guided Example(read) content in TOC
 *               , respective Guided example content should be displayed on
 *               right side of page
 */
public class GLP_318478_VerifyGuideContentAfterClickingOnGuidedExampleOnToc
		extends BaseClass {
	public GLP_318478_VerifyGuideContentAfterClickingOnGuidedExampleOnToc() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT, Groups.LEARNER,
			Groups.TOC }, enabled = true, description = "Verify that on On clicking Guided Example(read) content in TOC , respective Guided example content should be displayed on right side of page")
	public void verifyGuideContentAfterClickingOnGuidedExampleOnToc() {
		startReport(
				getTestCaseId(),
				"Verify that on On clicking Guided Example(read) content in TOC , respective Guided example content should be displayed on right side of page");
