 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 16.1
 *
 */
public class GLP_350911_VerifyCoreInstructionLo16_1 extends BaseClass {
	public GLP_350911_VerifyCoreInstructionLo16_1() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR }, enabled = true, description = "Verify that Instructor is able to verify core instruction for LO 16.1")
	public void verifyCoreInstructionLo16_1() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 16.1");
		...
		try {
			...
			// Navigate to the EO's of LO 16.1
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("16.1");
