 ...
 *              Questions for LO 16.6
 */
public class GLP_346338_VerifyPreviewQuestionsLo16_6 extends BaseClass {
    public GLP_346338_VerifyPreviewQuestionsLo16_6() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR, Groups.HEARTBEAT },
            enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 16.6")
    public void verifyPreviewQuestionsLO_16_6() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 16.6");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 16.6
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("16.6");
