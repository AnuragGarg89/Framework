 ...
 *               practice test by clicking the browser back button submitting
 *               the answer to a question ( 1st incorrect attempt)
 * 
 */
public class GLP_337233_FreeResponseSaveStateOnBrowserBack extends BaseClass {
    public GLP_337233_FreeResponseSaveStateOnBrowserBack() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER }, enabled = true,
            description = "Free Response question should be retained on exiting the practice test by clicking the browser back button submitting the answer to a question(1st incorrect attempt)")
    public void VerifyFreeResponseStateManagement() {
        startReport(getTestCaseId(),
                "Free Response question should be retained on exiting the practice test by clicking the browser back button after submitting the answer to a question (1st incorrect attempt)");
        ...
        try {
            ...
            objGLPLearnerPracticeTestPage.verifyElementPresent(
                    ...
                    "Feedback message should be retained after coming back to the practice test in 1st incorrect attempt");
            ...
            objGLPLearnerPracticeTestPage.verifyElementPresent(
                    "PracticeTestFeedbackMessage",
                    "Feedback message should be retained after coming back to the practice test in 2nd incorrect attempt");

            // Attempt practice test question in 3rd attempt
            objGLPLearnerDiagnosticTestPage.attemptAdaptiveDiagnosticTest(0, 1,
                    ResourceConfigurations
                            .getProperty("diagnosticSubmitButton"));
            ...
            // Verify save state for free response question in 3rd attempt
            objGLPLearnerPracticeTestPage.verifyText(
                    "PracticeTestFreeResponseTextBox",
                    ResourceConfigurations
                            .getProperty("freeResponseInputValue"),
                    "Free Response question should be retained on exiting the practice test submitting the answer to a question(3rd incorrect attempt)");

            // Verify feedback present after coming back on the same question
            objGLPLearnerPracticeTestPage.verifyElementPresent(
                    "PracticeTestFeedbackMessage",
                    "Feedback message should be retained after coming back to the practice test in 3rd incorrect attempt");
