 ...
 * 
 */
public class GLP_358630_VerifyLearnerEOsInLO14_3 extends BaseClass {
    public GLP_358630_VerifyLearnerEOsInLO14_3() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT, Groups.LEARNER,
            Groups.SANITY,Groups.DEV}, enabled = true,
            description = "LO-14.3 : To verify that all EOs and its contents are available to the learner and learner can complete the practice test available in each EO")
    public void verifyLearnerEOsInL014_3() {
        startReport(getTestCaseId(),
                "LO-14.3 : To verify that all EOs and its contents are available to the learner and learner can complete the practice test available in each EO");
        ...
        try {
            ...
            // Navigate to the Learning objectives page for LO 14.3
            GLPLearner_LearningObjectivePage objLO = objGLPLearnerCourseMaterialPage
                    .navigateToCoreInstructionsInLo("14.3");
