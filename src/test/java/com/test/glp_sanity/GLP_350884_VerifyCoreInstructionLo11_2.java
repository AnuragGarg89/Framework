 ...
 *
 */
public class GLP_350884_VerifyCoreInstructionLo11_2 extends BaseClass {
    public GLP_350884_VerifyCoreInstructionLo11_2() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.INSTRUCTOR, Groups.HEARTBEAT },
            enabled = true,
            description = "Verify that Instructor is able to verify core instruction for LO 11.2")
    public void verifyCoreInstructionLo11_2() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to verify core instruction for LO 11.2");
        ...
        try {
            ...
            // Navigate to the Eo's of LO 11.2
