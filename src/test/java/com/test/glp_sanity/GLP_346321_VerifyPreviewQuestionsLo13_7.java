 ...
 *              Questions for LO 13.7
 */
public class GLP_346321_VerifyPreviewQuestionsLo13_7 extends BaseClass {
    public GLP_346321_VerifyPreviewQuestionsLo13_7() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR, Groups.HEARTBEAT,Groups.PASSED },
            enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 13.7")
    public void verifyPreviewQuestionsLO_13_7() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 13.7");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 13.7
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("13.7");
