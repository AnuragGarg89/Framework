 ...
 * @author rashmi.z
 * @date Feb 12, 2018
 * @description: To Render "Static Borderless table with equation" as per visual
 *               design.
 * 
 */
public class GLP_306968_VerifyStaticBorderlessTableWithEquation
        extends BaseClass {
    public GLP_306968_VerifyStaticBorderlessTableWithEquation() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER }, enabled = false,
            description = "Verify Static Borderless table with equation.")
    public void VerifyStaticBorderlessTableWithEquation() {
        ...
        try {
            ...
            objProductApplication_DiagnosticTestPage
                    .verifyStaticBorderlessTableWithEquation();
