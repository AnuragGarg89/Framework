 ...
 *              Questions for LO 13.3
 */
public class GLP_346317_VerifyPreviewQuestionsLo13_3 extends BaseClass {
    public GLP_346317_VerifyPreviewQuestionsLo13_3() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR, Groups.HEARTBEAT,Groups.PASSED },
            enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 13.3")
    public void verifyPreviewQuestionsLO_13_3() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 13.3");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 13.3
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("13.3");
