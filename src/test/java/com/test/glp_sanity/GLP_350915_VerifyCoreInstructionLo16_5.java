 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 16.5
 *
 */
public class GLP_350915_VerifyCoreInstructionLo16_5 extends BaseClass {
	public GLP_350915_VerifyCoreInstructionLo16_5() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR }, enabled = true, description = "Verify that Instructor is able to verify core instruction for LO 16.5")
	public void verifyCoreInstructionLo16_5() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 16.5");
		...
		try {
			...
			// Navigate to the EO's of LO 16.5
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("16.5");
