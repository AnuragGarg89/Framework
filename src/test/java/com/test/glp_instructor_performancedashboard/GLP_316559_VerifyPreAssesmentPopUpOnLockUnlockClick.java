 ...
 * @date March 29, 2018
 * @description: Verify 'Unlock/Lock PreAssessment' pop-up when clicked on
 *               'Unlock/Lock' button
 *
 */
public class GLP_316559_VerifyPreAssesmentPopUpOnLockUnlockClick
        extends BaseClass {
    public GLP_316559_VerifyPreAssesmentPopUpOnLockUnlockClick() {
    }

    @Test(groups = { Groups.INSTRUCTOR, Groups.LEARNER, Groups.REGRESSION,
            Groups.NEWCOURSEREQUIRED }, enabled = true,
            description = "Verify 'Unlock/Lock PreAssessment' pop-up when clicked on 'Unlock/Lock' button.")
    public void verifyPreAssesmentPopUpWhenClickUnlockLock()
            throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify 'Unlock/Lock PreAssessment' pop-up when clicked on 'Unlock/Lock' button.");
        ...
        try {
            ...
            // Verify 'Unlock Pre-Assessment' pop-up is not present on UI
            ...
            // Verify 'Lock Pre-Assessment' pop-up is not present on UI
            objGLPInstructorDashboardPage.verifyElementNotPresent(
                    "UnlockPreAssessmentTest",
                    "Verify 'Lock Pre-Assessment' pop-up is not present on UI.");
