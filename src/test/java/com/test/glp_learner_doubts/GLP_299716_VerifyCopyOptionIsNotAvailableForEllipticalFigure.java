 ...
 * 
 */
public class GLP_299716_VerifyCopyOptionIsNotAvailableForEllipticalFigure
        extends BaseClass {
    public GLP_299716_VerifyCopyOptionIsNotAvailableForEllipticalFigure() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.FIGURE, Groups.LEARNER },
            enabled = false,
            description = "Verify Learner is not able to copy figure.")
    public void VerifyCopyOptionIsNotAvailableForEllipticalFigure() {
