...
public class GLPInstructor_CourseViewPage extends BaseClass
    ...
    public GLPInstructor_CourseViewPage(ExtentTest reportTestObj,
            Logger APP_LOGS) {
    ...
    public void clickOnCourseTile() {
        ...
        try {
            clickOnElement("CourseTileInstructor", "Click on course tile");
        } catch (Exception t) {
     ...
     * @return The object of ProductApplication_CourseViewPage
     */
    public GLPInstructor_CourseViewPage navigateToWelcomeScreenLearner() {
        APP_LOGS.debug("Navigate to welcome screen");
        try {
            clickOnElement("CourseViewStartDiagnosticButton",
                    "Click on Course Card in 'List' view.");
        } catch (Exception t) {
            APP_LOG.error(t.getMessage());
        }
        return new GLPInstructor_CourseViewPage(reportTestObj, APP_LOGS);
    }
     ...
     * @return The object of ProductApplication_CourseViewPage
     */
    public GLPInstructor_CourseViewPage navigateToCourseView() {
     ...
     * @return The object of ProductApplication_CourseViewPage
     */
    public GLPInstructor_CourseViewPage verifyMenuOptions() {
        APP_LOGS.debug(
     ...
     * @return The object of ProductApplication_CourseViewPage
     */
    public GLPInstructor_CourseViewPage verifyDefaultListView() {
     ...
     * @return The object of ProductApplication_CourseViewPage
     */
    public GLPInstructor_CourseViewPage switchToListOrGridView(String locator,
            String description) {
        APP_LOGS.debug(
     ...
     * @return The object of ProductApplication_CourseViewPage
     */
    public GLPInstructor_CourseViewPage verifySwitchedToGridView() {
        APP_LOGS.debug(
                "Verify learner is able to switch the view from list to grid.");
            ...
            if (webDriver instanceof SafariDriver
                ...
                js.executeScript("arguments[0].click();",
                        webDriver.findElement(By.cssSelector(
                                ".o-dropdown-menu button#header-nav-link-account")));
                TimeUnit.SECONDS.sleep(3);
                js.executeScript("arguments[0].click();",
                        webDriver.findElement(By.cssSelector(
                                "li.o-app-header__menu-item-sign-out a")));
            } else {
     ...
     * @return The object of ProductApplication_CourseViewPage
     */
    public GLPInstructor_CourseViewPage waitForCourseToAppear() {
     ...
     * @return The object of ProductApplication_CourseViewPage
     */
    public GLPInstructor_CourseViewPage handleAlertMsgPopup() {
        APP_LOGS.debug("Verify Rio Course name and its description");
        result = performAction.execute(ACTION_WAIT_FOR_ELEMENT_IS_VISIBLE,
     ...
     * @author Pallavi.Tyagi
     * @date 3 Oct,2017
     * @description navigate to performance dashboard
     * @return The object of ProductApplication_CourseViewPage
     */
    public GLPInstructor_InstructorDashboardPage
           navigateToPerformanceDashboard() {
        APP_LOG.debug("Navigate to performance dashboard");
        clickOnElement("CourseTileInstructor", "Click on on 'Course Tile'.");
        for (int i = 1; i <= 5; i++) {
        ...
        this.performAction.execute(ACTION_WAIT_FOR_ELEMENT_IS_VISIBLE,
                "InstructorDashBoardExportButton");
        this.result = verifyElementPresent("InstructorDashBoardExportButton",
     ...
     * @author Pallavi.Tyagi
     * @date 22 Nov,2017
     * @description Navigate to Management dashboard from courseview
     * @return The object of ProductApplication_CourseViewPage
     */
    public GLPInstructor_CourseViewPage navigateToManagementDashboard() {
    ...
    public GLPInstructor_WelcomeInstructorPage
        ...
        APP_LOGS.debug("Navigate to welcome screen");
        try {
            clickOnElement("CourseTileInstructor",
     ...
     * @author mehak.verma
     * @date 03 Nov,2017
     * @description Verify elements on welcome Instructor screen
     * @return The object of ProductApplication_WelcomeInstructorPage
     */
    public GLPInstructor_WelcomeInstructorPage verifyWelcomeInstructor() {
        APP_LOGS.debug("Verify welcome Intructor screen");
        try {
            clickOnElement("CourseTileInstructor", "Click on course tile");
        } catch (Exception t) {
            APP_LOG.error(t.getMessage());
     ...
     * @author mehak.verma
     * @date 02 Nov,2017
     * @description Verify navigation to Welcome screen Instructor
     * @return The object of ProductApplication_WelcomeInstructorPage
     */
    public GLPInstructor_WelcomeInstructorPage
           verifyNavigationToWelcomeScreenInstructor() {
        APP_LOGS.debug("Verify navigation to Welcome screen");
        try {
            clickOnElement("CourseTileInstructor", "Click on course tile");
     ...
     * @author nitish.jaiswal
     * @date 10 Nov,2017
     * @description Navigate to Instructor Dashboard from Course View screen for
     *              instructor
    ...
    public GLPInstructor_InstructorDashboardPage
        ...
        APP_LOG.debug("Navigate to Instructor Dashboard Page for INSTRUCTOR");
        try {
            clickOnElement("CourseTileInstructor",
                    "Click on 'Course Tile' to move to Instructor Dashboard Page for Instructor.");
            for (int i = 1; i <= 3; i++) {
                if (performAction
                        .execute(ACTION_WAIT_FOR_ELEMENT_IS_VISIBLE,
                                "InstructorDashBoardExportButton")
            ...
            this.result = verifyElementPresent(
                    "InstructorDashBoardExportButton",
                    "Verify instructor has navigated to Performance Dashboard page.");
        } catch (Exception t) {
            APP_LOG.error(t.getMessage());
     ...
     */
    public GLPInstructor_CourseViewPage verifyElementNotPresent(String locator,
            String message) {
     ...
     * @return The object of ProductApplication_WelcomeInstructorPage
     */
    public GLPInstructor_MasterySettingPage navigateToMasterySetting() {
        APP_LOGS.debug("Navigate to welcome screen");
        try {
            clickOnElement("CourseTileInstructor", "Click on course tile");
        } catch (Exception t) {
     ...
     * @return The object of ProductApplication_CourseViewPage
     */
    public GLPInstructor_CourseViewPage waitForCourseToAppearInstructor() {
        APP_LOGS.debug("Verify Rio Course name and its description");
     ...
     * @return The object of ProductApplication_CourseViewPage
     */
    public GLPInstructor_CourseViewPage verifyFooterHyperLinks(String locator,
            String desc) {
        FindElement element = new FindElement();
     ...
     */
    public GLPInstructor_CourseViewPage verifyFooterHyperLinks() {
        ...
        verifyText("DashBoardFooterTermsAndConditionsLink",
                ResourceConfigurations.getProperty("termsOfUseText"),
                "Verify 'Terms & Conditions' link text is present");
        return new GLPInstructor_CourseViewPage(reportTestObj, APP_LOG);
    }
     ...
     */
    public GLPInstructor_CourseViewPage verifyDiagonasticPageHeaders() {
     ...
     * @return The object of GLPLearner_CourseViewPage
     */
    public GLPInstructor_CourseViewPage verifyDiagonasticPageFooters() {
     ...
     * @return The object of GLPLearner_CourseViewPage
     */
    public GLPInstructor_CourseViewPage
    ...
    public GLPInstructor_CourseViewPage
        ...
        verifyElementPresent("InstructorDashBoardFooterCopyRightText",
                "Verify text in left bottom corner of footer section.");
        verifyElementPresent("InstructorDashBoardFooterAccessibilityLink",
                "Verify Accessibility Link");
        verifyElementPresent("InstructorDashBoardPrivacyPolicyLink",
                "Verify Privacy Policy Link");
        verifyElementPresent("InstructorDashBoardFooterTermsAndConditionsLink",
                "Verify Term and condition");
    ...
    public String getText(String element, String stepDesc) {
        ...
        this.APP_LOGS.debug(stepDesc);
        this.performAction.execute(ACTION_WAIT_FOR_ELEMENT_IS_VISIBLE, element);
        this.result = this.performAction.execute(ACTION_GET_TEXT, element);
        return this.result;
    }
    ...
    public GLPInstructor_CourseViewPage verifyDistractor(String distractor,
            String userName) {
        ...
        try {
            ...
            if (distractortype == "None") {
                ...
                if (!(distractorvalue.contains("A.")
                    ...
                    return new GLPInstructor_CourseViewPage(reportTestObj,
                            APP_LOG);
                }
            }
