 ...
 *               logging out of application and logging back
 */

public class GLP_339429_VerifyStateOfRecommendedLAOnLoggingOut
        extends BaseClass {
    public GLP_339429_VerifyStateOfRecommendedLAOnLoggingOut() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER }, enabled = true,
            description = "Verify state of Recommended Learning Aids remains the same on logging out of application and logging in back")
    public void verifyStateOfRecommendedLAOnClosingPracticeTest() {
        startReport(getTestCaseId(),
                "Verify state of Recommended Learning Aids remains the same on logging out of application and logging in back");
        ...
        try {
            ...
            // Close the practice assessment player
            objGLPLearnerPracticeTestPage.closePracticeAssessmentPlayer();
            // Click on browser back to navigate to course home page
            objGLPLearnerPracticeTestPage
                    .clickBrowserBackButton("Click on the browser back button");
