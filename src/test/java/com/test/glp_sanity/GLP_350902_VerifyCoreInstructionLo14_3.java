 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 14.3
 *
 */
public class GLP_350902_VerifyCoreInstructionLo14_3 extends BaseClass {
	public GLP_350902_VerifyCoreInstructionLo14_3() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR }, enabled = false, description = "Verify that Instructor is able to verify core instruction for LO 14.3")
	public void verifyCoreInstructionLo14_3() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 14.3");
		...
		try {
			...
			// Navigate to the EO's of LO 14.3
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("14.3");
