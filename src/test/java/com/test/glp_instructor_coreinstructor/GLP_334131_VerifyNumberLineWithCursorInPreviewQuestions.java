...
public class GLP_334131_VerifyNumberLineWithCursorInPreviewQuestions
        extends BaseClass {

    public GLP_334131_VerifyNumberLineWithCursorInPreviewQuestions() {

    }

    @Test(groups = { Groups.REGRESSION, Groups.INSTRUCTOR }, enabled = true,
            description = "To verify number line with cursor is displayed in preview mode on Preview Questions")
    public void verifyNumberLineWithCursorInPreviewQuestions() {

        startReport(getTestCaseId(),
                "To verify number line with cursor is displayed in preview mode on Preview Questions");
        ...
        try {
            ...
            // Navigate to Number Line with Cursor
            objProductCoreInstructionPage.navigateToQuestionType(
                    "NumberLineWithCursor",
                    "Verify number line with cursor Question is present");
