 ...
 * 
 */
public class GLP_358638_VerifyLearnerEOsInLO16_1 extends BaseClass {
    public GLP_358638_VerifyLearnerEOsInLO16_1() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT, Groups.LEARNER,
            Groups.SANITY, Groups.DEV }, enabled = true,
            description = "LO-16.1 : To verify that all EOs and its contents are available to the learner and learner can complete the practice test available in each EO")
    public void verifyLearnerEOsInL016_1() {
        startReport(getTestCaseId(),
                "LO-16.1 : To verify that all EOs and its contents are available to the learner and learner can complete the practice test available in each EO");
        ...
        try {
            ...
            // Navigate to the Learning objectives page for LO 16.1
