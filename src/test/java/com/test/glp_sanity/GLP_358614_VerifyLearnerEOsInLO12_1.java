 ...
 * 
 */
public class GLP_358614_VerifyLearnerEOsInLO12_1 extends BaseClass {
    public GLP_358614_VerifyLearnerEOsInLO12_1() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT, Groups.LEARNER,
            Groups.SANITY }, enabled = true,
            description = "LO-12.1 : To verify that all EOs and its contents are available to the learner and learner can complete the practice test available in each EO")
    public void verifyLearnerEOsInL012_1() {
        startReport(getTestCaseId(),
                "LO-12.1 : To verify that all EOs and its contents are available to the learner and learner can complete the practice test available in each EO");
        ...
        try {
            ...
            // Navigate to the Learning objectives page for LO 12.1
            GLPLearner_LearningObjectivePage objLO = objGLPLearnerCourseMaterialPage
                    .navigateToCoreInstructionsInLo("12.1");
