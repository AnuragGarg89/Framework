 ...
 *               'Ready' state when selected - 'All Students' and 'All Modules'
 */
public class GLP_339610_VerifyTOTForAllStudentAndAllModule extends BaseClass {
    public GLP_339610_VerifyTOTForAllStudentAndAllModule() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER, Groups.INSTRUCTOR },
            enabled = true,
            description = "Verify TOT for learner in 'Not Started' and 'Placed Out' and 'Ready' state when selected - 'All Students' and 'All Modules'")
    public void verifyTOTForReadyStateInModule() {
        startReport(getTestCaseId(),
                "Verify TOT for learner in 'Not Started' and 'Placed Out' and 'Ready' state when selected - 'All Students' and 'All Modules'");
        ...
        try {
            ...
            // Click on 'All Modules' from drop down value
            objGLPInstructorDashboardPage.clickOnElement(
                    "InstructorDashBoardAllModules",
                    "Click on 'All Modules' from dropdown value.");
            ...
            // Verify learner should not display when status is 'Not Started'
            // and filter selected are - 'All Students' and 'All Modules'
            objGLPInstructorDashboardPage.verifyTextContains(
                    "InstructorDashBoardPerformanceNoRecordFound",
                    ResourceConfigurations.getProperty("noRecordFound"),
                    "Verify learner should not display when status is 'Not Started' and filter selected are - 'All Students' and 'All Modules'.");
