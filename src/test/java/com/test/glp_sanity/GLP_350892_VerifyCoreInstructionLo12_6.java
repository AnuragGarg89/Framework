 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 12.6
 *
 */
public class GLP_350892_VerifyCoreInstructionLo12_6 extends BaseClass {
	public GLP_350892_VerifyCoreInstructionLo12_6() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR, Groups.HEARTBEAT }, enabled = true, description = "Verify that Instructor is able to verify core instruction for LO 12.6")
	public void verifyCoreInstructionLo12_6() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 12.6");
		...
		try {
			...
			// Navigate to the EO's of LO 12.6
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("12.6");
