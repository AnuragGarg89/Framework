 ...
 *               standards for the dignosist: MCQ_SA question page
 */
public class GLP_283574_VerifyAccessibilityLearnerDiagnosticMCQ_SAPage
        extends BaseClass {
    public GLP_283574_VerifyAccessibilityLearnerDiagnosticMCQ_SAPage() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.ACCESSIBILITY, Groups.LEARNER },
            enabled = true,
            description = "Verify Web Content Accessibility Guidelines (WCAG) 2.0 with AA standards for the dignosist: MCQ_SA question page")
    public void verifyAccessibilityLearnerDiagnosticMCQ_SAPage() {
        startReport(getTestCaseId(),
                "Verify Web Content Accessibility Guidelines (WCAG) 2.0 with AA standards for the dignosist: MCQ_SA question page");
