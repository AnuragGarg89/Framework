 ...
 * 
 */
public class GLP_339188_VerifyGreaterThanLessThanSymbolInMathPallet
        extends BaseClass {

    @Test(groups = { Groups.REGRESSION, Groups.HEARTBEAT }, enabled = true,
            description = "To Verify Greater Than Less Than Symbol Present In Math Pallet")
    public void verifyMathPalletSymbols() {
        startReport(getTestCaseId(),
                "To Verify Greater Than Less Than Symbol Present In Math Pallet");
        ...
        try {
            ...
            objProductApplication_DiagnosticTestPage
                    .verifyFreeResponseGreaterLessThanSymbol();
        } finally {
