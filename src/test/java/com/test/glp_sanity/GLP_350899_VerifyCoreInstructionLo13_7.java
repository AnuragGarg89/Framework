 ...
 * @author anurag.garg1
 * @date 2018-05-23
 * @description Verify that Instructor is able to verify core instruction for LO 13.7
 *
 */
public class GLP_350899_VerifyCoreInstructionLo13_7 extends BaseClass {
	public GLP_350899_VerifyCoreInstructionLo13_7() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.SANITY,
			Groups.INSTRUCTOR, Groups.HEARTBEAT }, enabled = false, description = "Verify that Instructor is able to verify core instruction for LO 13.7.")
	public void verifyCoreInstructionLo13_7() throws InterruptedException {
		startReport(getTestCaseId(), "Verify that Instructor is able to verify core instruction for LO 13.7");
		...
		try {
			...
			// Navigate to the EO's of LO 13.7
			objProductInstructorManagementDashboardPage.navigateToCoreInstructionsInLo("13.7");
