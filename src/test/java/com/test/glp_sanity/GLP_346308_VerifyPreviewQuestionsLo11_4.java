 ...
 *              Questions for LO 11.4
 */
public class GLP_346308_VerifyPreviewQuestionsLo11_4 extends BaseClass {
    public GLP_346308_VerifyPreviewQuestionsLo11_4() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR,
            Groups.HEARTBEAT, Groups.PASSED }, enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 11.4")
    public void verifyPreviewQuestionsLO_11_4() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 11.4");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 11.4
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("11.4");
