 ...
 * @date May 04, 2018
 * @description: Verify Post Assessment No. Of Try And Learnig Aid Functionality
 * 
 */
public class GLP_358018_VerifyPostAssessmentNoOfTryAndLearnigAidFunctionality
        extends BaseClass {
    public GLP_358018_VerifyPostAssessmentNoOfTryAndLearnigAidFunctionality() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER, Groups.HEARTBEAT,
            Groups.SANITY }, enabled = true,
            description = "Verify Post Assessment No. Of Try And Learnig Aid Functionality")
    public void verifyPostAssessmentNoOfTryAndLearnigAidFunctionality() {
        startReport(getTestCaseId(),
                "Verify Post Assessment No. Of Try And Learnig Aid Functionality");
        ...
        try {
            ...
            // Verify Submit button should be Non active.
            objGLPLearnerPostAssessmentPage.verifyButtonEnabledOrDisabled(
                    "SubmitButton", "yes",
                    "Verify 'Submit' button is enabled when no answer is selected.");
            objGLPLearnerPostAssessmentPage.navigateToSpecificQuestionType(
                    ResourceConfigurations.getProperty("fibFreeResponse"));

            // Verify No Of Try And Learnig Aid Functionality
            objGLPLearnerPostAssessmentPage
                    .verifyNoOfTryAndLearnigAidFunctionality(
                            ResourceConfigurations
