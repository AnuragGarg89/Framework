 ...
 *               test.
 */
public class GLP_358029_VerifyDiagnosticTestResume extends BaseClass {
    public GLP_358029_VerifyDiagnosticTestResume() {
    }
    ...
    public void verifyCompleteDiagnosticTestAttempted() {
        ...
        try {
            ...
            objGLPLearnerDiagnosticTestPage.attemptAdaptiveDiagnosticTest(0, 4,
