 ...
 * @date Dec 18, 2017
 * @description: Verify the Multiselect question rendering in card view
 * 
 */
public class GLP_284774_VerifyCardViewMultiSelectQuestion extends BaseClass {
    public GLP_284774_VerifyCardViewMultiSelectQuestion() {
    }
    ...
    public void verifyCardViewMultiSelectQuestion() {
        startReport(getTestCaseId(),
                "Verify the Multiselect question rendering in card view ");
        ...
        try {
            ...
            // Verify the Multi Select question rendering in card view
            objGLPLearnerDiagnosticTestPage.verifyCardView(2);
