 ...
 *              Questions for LO 12.1
 */
public class GLP_346309_VerifyPreviewQuestionsLo12_1 extends BaseClass {
    public GLP_346309_VerifyPreviewQuestionsLo12_1() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR, Groups.HEARTBEAT },
            enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 12.1")
    public void verifyPreviewQuestionsLO_12_1() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 12.1");
