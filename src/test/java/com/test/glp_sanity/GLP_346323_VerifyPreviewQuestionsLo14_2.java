 ...
 *              Questions for LO 14.2
 */
public class GLP_346323_VerifyPreviewQuestionsLo14_2 extends BaseClass {
    public GLP_346323_VerifyPreviewQuestionsLo14_2() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR,
            Groups.HEARTBEAT,Groups.PASSED }, enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 14.2")
    public void verifyPreviewQuestionsLO_14_2() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 14.2");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 14.2
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("14.2");
