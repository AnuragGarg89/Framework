 ...
 * @author rashmi.z
 * @date Feb 21, 2018
 * @description: To verify web browser supports rendering ellipse figure
 * 
 */
public class GLP_299710_VerifyWebBrowserSupportsRenderingElipticalFigure
        extends BaseClass {
    public GLP_299710_VerifyWebBrowserSupportsRenderingElipticalFigure() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.FIGURE, Groups.LEARNER },
            enabled = false,
            description = "Verify web browser supports rendering ellipse figure")
    public void VerifyWebBrowserSupportsRenderingElipticalFigure() {
        startReport(getTestCaseId(),
                "Verify verify web browser supports rendering ellipse figure");
