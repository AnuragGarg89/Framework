 ...
 *              Questions for LO 15.2
 */
public class GLP_346329_VerifyPreviewQuestionsLo15_2 extends BaseClass {
    public GLP_346329_VerifyPreviewQuestionsLo15_2() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR,
            Groups.HEARTBEAT }, enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 15.2")
    public void verifyPreviewQuestionsLO_15_2() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 15.2");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 15.2
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("15.2");
