 ...
 *               test before and attempted at-least one question but haven't
 *               submitted it.
 */
public class GLP_323052_VerifyContinueButtonPresenceAfterStartingPracticeTest
        extends BaseClass {
    public GLP_323052_VerifyContinueButtonPresenceAfterStartingPracticeTest() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER }, enabled = true,
            description = "To verify if the student is now able to see the practice test page with Continue button when he/she has started the practice test before and attempted at-least one question but haven't submitted it.")
    public void verifyContinueButtonPresenceAfterStartingPracticeTest() {
        startReport(getTestCaseId(),
                "To verify if the student is now able to see the practice test page with Continue button when he/she has started the practice test before and attempted at-least one question but haven't submitted it.");
        ...
        try {
            ...
            String questionTextBefore = objGLPLearnerPracticeTestPage
                    .getText("PracticeTest1stQuestionText");
            // attempt 1 question of practice test but not submit
            ...
            String questionTextAfter = objGLPLearnerPracticeTestPage
                    .getText("PracticeTest1stQuestionText");
            objGLPLearnerPracticeTestPage.compareText(questionTextBefore,
                    questionTextAfter);
