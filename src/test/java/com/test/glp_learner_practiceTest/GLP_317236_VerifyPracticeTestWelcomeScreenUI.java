 ...
 * 
 */
public class GLP_317236_VerifyPracticeTestWelcomeScreenUI extends BaseClass {
    public GLP_317236_VerifyPracticeTestWelcomeScreenUI() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER }, enabled = true,
            description = "Verify the UI of practice test welcome screen except last LO")
    public void VerifyPracticeTestWelcomeScreenUI() {
        ...
        try {
            ...
            objGLPLearnerPracticeTestPage.verifyText("PracticeTestWelcomeText",
                    ResourceConfigurations
                            .getProperty("practiceTestWelcomeHeaderText"),
            ...
            objGLPLearnerPracticeTestPage.verifyText(
                    ...
                    ResourceConfigurations
                            .getProperty("practiceTestWelcomeBodyText"),
