 ...
 *              Questions for LO 13.2
 */
public class GLP_346316_VerifyPreviewQuestionsLo13_2 extends BaseClass {
    public GLP_346316_VerifyPreviewQuestionsLo13_2() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR,
            Groups.HEARTBEAT }, enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 13.2")
    public void verifyPreviewQuestionsLO_13_2() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 13.2");
        ...
        try {
            ...
            // Navigate to the Preview Questions of LO 13.2
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("13.2");
