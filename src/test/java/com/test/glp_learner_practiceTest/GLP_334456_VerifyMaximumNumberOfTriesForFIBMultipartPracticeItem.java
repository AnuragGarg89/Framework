 ...
 *               of choices- 1" for FIB multipart Practice item
 */

public class GLP_334456_VerifyMaximumNumberOfTriesForFIBMultipartPracticeItem
        extends BaseClass {
    public GLP_334456_VerifyMaximumNumberOfTriesForFIBMultipartPracticeItem() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.LEARNER }, enabled = true,
            description = "To verify maximum number of tries displayed is equal to number of choices- 1 for FIB multipart Practice item")
    public void verifyMaximumNumberOfTriesForFIBMultipartPracticeItem() {
        startReport(getTestCaseId(),
                "To verify maximum number of tries displayed is equal to number of choices- 1 for FIB multipart Practice item");
