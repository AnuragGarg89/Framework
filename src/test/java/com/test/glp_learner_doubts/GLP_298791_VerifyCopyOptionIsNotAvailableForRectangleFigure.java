 ...
 * @author rashmi.z
 * @date Jan 25, 2018
 * @description: To verify Learner is not able to copy figure.
 * 
 */
public class GLP_298791_VerifyCopyOptionIsNotAvailableForRectangleFigure
        extends BaseClass {
    public GLP_298791_VerifyCopyOptionIsNotAvailableForRectangleFigure() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.FIGURE, Groups.LEARNER },
            enabled = false,
            description = "Verify Learner is not able to copy figure.")
    public void VerifyCopyOptionIsNotAvailableForRectangleFigure() {
        startReport(getTestCaseId(),
                "Verify Learner is not able to copy figure.");
