 ...
 * 
 */
public class GLP_338668_VerifyThatInstructorAbleToSeeNumberOfAttemptsWhenStudentMadeForPracticeTestAndValueDisplayInCurrentContentColumn
        extends BaseClass {
    public GLP_338668_VerifyThatInstructorAbleToSeeNumberOfAttemptsWhenStudentMadeForPracticeTestAndValueDisplayInCurrentContentColumn() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.INSTRUCTOR }, enabled = false,
            description = "To verify that instructor should be able to see number of attempts when a student has made for practice test and value display in current content column")
    public void
           verifyThatInstructorAbleToSeeNumberOfAttemptsWhenStudentMadeForPracticeTestAndValueDisplayInCurrentContentColumn() {
        startReport(getTestCaseId(),
                "To verify that instructor should be able to see number of attempts when a student has made for practice test and value display in current content column");
        ...
        try {
            ...
            objProductApplicationInstructorDashboardPage.verifyText(
                    "PerforManceDashBoardAttempt1Text",
                    ResourceConfigurations.getProperty("attempt1Text"),
                    "Verify 'Attempt 1' Text is displayed in 'Current Content' column");
