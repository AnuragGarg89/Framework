 ...
 *              Questions for LO 11.3
 */
public class GLP_346307_VerifyPreviewQuestionsLo11_3 extends BaseClass {
    public GLP_346307_VerifyPreviewQuestionsLo11_3() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.SANITY, Groups.INSTRUCTOR, Groups.HEARTBEAT },
            enabled = true,
            description = "Verify that Instructor is able to preview the complete Preview Questions for LO 11.3")
    public void verifyPreviewQuestionsLO_11_3() throws InterruptedException {
        startReport(getTestCaseId(),
                "Verify that Instructor is able to preview the complete Preview Questions for LO 11.3");
        ...
        try {
            ...
            objProductInstructorManagementDashboardPage
                    .navigateToPreviewQuestionsInLo("11.3");
