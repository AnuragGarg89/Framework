 ...
 * 
 */
public class GLP_328233_VerifyPostAssesmentWelcomePageLocalization extends
		BaseClass {
	public GLP_328233_VerifyPostAssesmentWelcomePageLocalization() {
	}

	@Test(groups = { Groups.REGRESSION, Groups.LEARNER }, enabled = true, description = "Verify readiness date on 'Unlock' pop-up when learner is in locked state")
	public void verifyPostAssesmentWelcomePageLocalization() {
		...
		try {
			...
			objGLPLearnerCourseMaterialPage
					.verifyTextContains(
							...
							ResourceConfigurations
									.getProperty("module11StartButton"),
			...
			objGLPLearnerPostAssessmentPage
			...
			objGLPLearnerPostAssessmentPage.verifyText(
					"WelcomeYouAreReadyParagraph",
					ResourceConfigurations
							.getProperty("postAssessmentWelcome1"),
					"Verify first hearder Text"
							+ ResourceConfigurations.getProperty("language"));

			// Verify course home header text
			objGLPLearnerPostAssessmentPage.verifyText(
					"WelcomeYouGoalParagraph",
					ResourceConfigurations
							.getProperty("postAssessmentWelcome2"),
					"Verify second hearder Text"
							+ ResourceConfigurations.getProperty("language"));

			// Verify course home Go text
			objGLPLearnerPostAssessmentPage.verifyText(
					"ModuleTestWelcomeScreenGoalText",
					ResourceConfigurations
							.getProperty("postAssessmentWelcomeGoal"),
					"Verify GOAL Text"
							+ ResourceConfigurations.getProperty("language"));

			// Verify course Start Button text
			objGLPLearnerPostAssessmentPage.verifyText(
					"ModuleTestWelcomeScreenStartButton",
					ResourceConfigurations
							.getProperty("postAssessmentStartTest"),
					"Verify second hearder Text"
							+ ResourceConfigurations.getProperty("language"));
