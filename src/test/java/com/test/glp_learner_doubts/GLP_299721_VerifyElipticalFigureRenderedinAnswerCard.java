 ...
 * @author rashmi.z
 * @date Feb 22, 2018
 * @description: To verify ellipse figure is rendered in the Answer Statement..
 * 
 */
public class GLP_299721_VerifyElipticalFigureRenderedinAnswerCard
        extends BaseClass {
    public GLP_299721_VerifyElipticalFigureRenderedinAnswerCard() {
    }

    @Test(groups = { Groups.REGRESSION, Groups.FIGURE, Groups.LEARNER },
            enabled = false,
            description = "Verify ellipse figure is rendered in the Answer Statement.")
    public void VerifyElipticalFigureRenderedinAnswerCard() {
        startReport(getTestCaseId(),
                "Verify ellipse figure is rendered in the Answer Statement.");
